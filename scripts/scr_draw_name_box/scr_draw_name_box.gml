function scr_draw_name_box(what_string_to_edit, box_color, white_rectangle_alpha, xx, yy)
{
	...
	if (point_in_rectangle(window_mouse_get_x(), window_mouse_get_y(), xx - 150, yy - 16, xx + 150, yy + 16))
	...
	draw_text_outlined(xx, yy, string(what_string_to_edit), global.default_text_size, c_white, c_black, 1);
