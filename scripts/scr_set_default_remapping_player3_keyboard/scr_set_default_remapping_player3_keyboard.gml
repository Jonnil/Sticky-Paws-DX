function scr_set_default_remapping_player3_keyboard(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config == true)
	{
		...
		ini_write_real("config", "player3_key_dive", global.player_[inp.key][3][1][action.dive]);
		ini_write_real("config", "player3_key2_dive", global.player_[inp.key][3][2][action.dive]);
		ini_write_real("config", "player3_key_jump", global.player_[inp.key][3][1][action.jump]);
		ini_write_real("config", "player3_key2_jump", global.player_[inp.key][3][2][action.jump]);
		ini_write_real("config", "player3_key_double_jump", global.player_[inp.key][3][1][action.double_jump]);
		ini_write_real("config", "player3_key2_double_jump", global.player_[inp.key][3][2][action.double_jump]);
		ini_write_real("config", "player3_key_crouch", global.player_[inp.key][3][1][action.crouch]);
		ini_write_real("config", "player3_key2_crouch", global.player_[inp.key][3][2][action.crouch]);
		ini_write_real("config", "player3_key_crouch_toggle", global.player_[inp.key][3][1][action.crouch_toggle]);
		ini_write_real("config", "player3_key2_crouch_toggle", global.player_[inp.key][3][2][action.crouch_toggle]);
		ini_write_real("config", "player3_key_sprint", global.player_[inp.key][3][1][action.sprint]);
		ini_write_real("config", "player3_key2_sprint", global.player_[inp.key][3][2][action.sprint]);
		ini_write_real("config", "player3_key_sprint_toggle", global.player_[inp.key][3][1][action.sprint_toggle]);
		ini_write_real("config", "player3_key2_sprint_toggle", global.player_[inp.key][3][2][action.sprint_toggle]);
		ini_write_real("config", "player3_key_left", global.player_[inp.key][3][1][action.left]);
		ini_write_real("config", "player3_key2_left", global.player_[inp.key][3][2][action.left]);
		ini_write_real("config", "player3_key_right", global.player_[inp.key][3][1][action.right]);
		ini_write_real("config", "player3_key2_right", global.player_[inp.key][3][2][action.right]);
		ini_write_real("config", "player3_key_down", global.player_[inp.key][3][1][action.down]);
		ini_write_real("config", "player3_key2_down", global.player_[inp.key][3][2][action.down]);
		ini_write_real("config", "player3_key_up", global.player_[inp.key][3][1][action.up]);
		ini_write_real("config", "player3_key2_up", global.player_[inp.key][3][2][action.up]);
		ini_write_real("config", "player3_key_tongue", global.player_[inp.key][3][1][action.tongue]);
		ini_write_real("config", "player3_key2_tongue", global.player_[inp.key][3][2][action.tongue]);
		ini_write_real("config", "player3_key_zoom_in", global.player_[inp.key][3][1][action.zoom_in]);
		ini_write_real("config", "player3_key2_zoom_in", global.player_[inp.key][3][2][action.zoom_in]);
		ini_write_real("config", "player3_key_zoom_out", global.player_[inp.key][3][1][action.zoom_out]);
		ini_write_real("config", "player3_key2_zoom_out", global.player_[inp.key][3][2][action.zoom_out]);
		ini_write_real("config", "player3_key_accept", global.player_[inp.key][3][1][action.accept]);
		ini_write_real("config", "player3_key2_accept", global.player_[inp.key][3][2][action.accept]);
		ini_write_real("config", "player3_key_back", global.player_[inp.key][3][1][action.back]);
		ini_write_real("config", "player3_key2_back", global.player_[inp.key][3][2][action.back]);
