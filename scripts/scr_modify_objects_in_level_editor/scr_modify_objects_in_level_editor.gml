function scr_modify_objects_in_level_editor()
{
	...
	and (asset_get_type("obj_level_player1_start") == asset_object)
	and (!place_meeting(x, y, obj_level_player1_start))
	and (asset_get_type("obj_level_player2_start") == asset_object)
	and (!place_meeting(x, y, obj_level_player2_start))
	and (asset_get_type("obj_level_player3_start") == asset_object)
	and (!place_meeting(x, y, obj_level_player3_start))
	and (asset_get_type("obj_level_player4_start") == asset_object)
