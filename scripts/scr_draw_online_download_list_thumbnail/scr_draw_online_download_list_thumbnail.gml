...
function scr_draw_online_download_list_thumbnail(thumbnail_index, number_of_thumbnails)
{
	...
	&& (can_draw_thumbnail)
	{
		...
		if (is_array(zero_defeats_level))
		{
			...
			else if (zero_defeats_level[thumbnail_index] == 2)
			{
	...
	&& (can_draw_thumbnail)
	{
		...
		else if (liked_content[thumbnail_index] == -1)
		{
