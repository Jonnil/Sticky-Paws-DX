...
function scr_savelevel()
{
	...
	and (global.actually_play_edited_level)
	{
		...
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "lives_until_assist", global.lives_until_assist);
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "x_checkpoint", global.x_checkpoint);
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "y_checkpoint", global.y_checkpoint);
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "checkpoint_millisecond", global.checkpoint_millisecond);
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "checkpoint_second", global.checkpoint_second);
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "checkpoint_minute", global.checkpoint_minute);
		ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "checkpoint_realmillisecond", global.checkpoint_realmillisecond);
		if (global.timeattack_realmillisecond > 2)
		
		#region /*Save Fastest Time*/
		if (!ini_key_exists(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "timeattack_realmillisecond"))
		or(global.timeattack_realmillisecond<ini_read_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "timeattack_realmillisecond", global.timeattack_realmillisecond))
		{
			ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "timeattack_millisecond", global.timeattack_millisecond);
			ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "timeattack_second", global.timeattack_second);
			ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "timeattack_minute", global.timeattack_minute);
			ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "timeattack_realmillisecond", global.timeattack_realmillisecond);
		}
		#endregion /*Save Fastest Time END*/
		
		if (score > ini_read_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "level_score", false))
		{
			ini_write_real(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index), "level_score", score);
		}
		ini_close();
	}
}
