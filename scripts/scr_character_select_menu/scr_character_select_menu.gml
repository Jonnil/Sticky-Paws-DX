...
function scr_character_select_menu()
{
	...
	and (global.skin_for_player_3 > 0)
	{
		...
		global.sprite_select_player_3 = scr_initialize_custom_character_select_sprite("idle", global.sprite_select_player_3, sprite_stand_xorig, sprite_stand_yorig, 2, global.skin_for_player_3);
				...
				if (player4_accept_selection = false)
				{
					...
					and (global.controls_used_for_menu_navigation = "mouse")
					{
						...
						and (global.skin_for_player_4 > 0)
						{
							...
							#region /*Player 4 character select portrait sprite*/
							global.sprite_select_player_4 = spr_noone;
							global.sprite_select_player_4 = scr_initialize_custom_character_select_sprite("walk", global.sprite_select_player_4, sprite_walk_xorig, sprite_walk_yorig, 2, global.skin_for_player_4);
							global.sprite_select_player_4 = scr_initialize_custom_character_select_sprite("idle", global.sprite_select_player_4, sprite_stand_xorig, sprite_stand_yorig, 2, global.skin_for_player_4);
