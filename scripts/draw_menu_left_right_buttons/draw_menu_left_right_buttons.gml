function draw_menu_left_right_buttons(left_right_buttons_x, left_right_buttons_y, left_right_buttons_right_arrow_x, left_right_buttons_text, left_right_buttons_variable_to_change, left_right_buttons_menu, scale_increment, left_right_buttons_can_go_below_0)
{
	...
	draw_text_outlined(left_right_buttons_x, 20 + (left_right_buttons_y), text(string(left_right_buttons_text)) + ": " + string(left_right_buttons_variable_to_change), global.default_text_size * 1.1, c_menu_outline, c_menu_fill, 1);
	...
	if (point_in_rectangle(window_mouse_get_x(), window_mouse_get_y(), left_right_buttons_x + left_right_buttons_right_arrow_x - 16 - size_of_button_offset, 20 + (left_right_buttons_y) - 16, left_right_buttons_x + left_right_buttons_right_arrow_x + 16, 20 + (left_right_buttons_y) + 16))
	and (global.controls_used_for_menu_navigation = "mouse")
	{
		menu = string(left_right_buttons_menu);
		menu_cursor_y_position = left_right_buttons_y;
	...
	if (point_in_rectangle(window_mouse_get_x(), window_mouse_get_y(), left_right_buttons_x - 32 - 16, 20 + (left_right_buttons_y) - 16, left_right_buttons_x + left_right_buttons_right_arrow_x + 16, 20 + (left_right_buttons_y) + 16))
	and (global.controls_used_for_menu_navigation = "mouse")
	{
		menu = string(left_right_buttons_menu);
		menu_cursor_y_position = left_right_buttons_y;
