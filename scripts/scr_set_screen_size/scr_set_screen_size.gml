function scr_set_screen_size()
{
	...
	switch (global.gui_scale_modifier)
	{
		/* GUI Scale Auto */ case 0:
			...
			/* 1600 x 900 */ if (window_get_width() >= 1600 - 40 && window_get_height() >= 900 - 40){global.gui_width = window_width * 1.1; global.gui_height = window_height * 1.1; break;}else
			/* 1280 x 720 */ if (window_get_width() >= 1280 - 40 && window_get_height() >= 720 - 40){global.gui_width = window_width * 1.2; global.gui_height = window_height * 1.2; break;}else
			/* 1024 x 576 */ if (window_get_width() >= 1024 - 40 && window_get_height() >= 576 - 40){global.gui_width = window_width * 1.3; global.gui_height = window_height * 1.4; break;}else
			/* 960 x 540 */ if (window_get_width() >= 960 - 40 && window_get_height() >= 540 - 40){global.gui_width = window_width * 1.4; global.gui_height = window_height * 1.4; break;}else
