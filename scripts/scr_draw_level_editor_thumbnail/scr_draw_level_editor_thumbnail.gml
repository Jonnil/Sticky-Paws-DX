/// @desc Draw the level editor thumbnail
/// @param {id.dslist<string>} [load_what_levels]=global.all_loaded_custom_levels Description
/// @param {bool} [show_first_thumbnail_name]=false Description
