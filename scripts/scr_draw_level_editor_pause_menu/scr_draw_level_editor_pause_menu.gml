	...
	&& (pressing_play_timer == 0)
	{
		...
		|| (menu == "generate_level_map_no")
		{
			...
			if (global.enable_option_for_pc)
			{
				...
				var file_path_text = string_replace_all(string_replace_all(game_save_id, environment_get_variable("USERNAME"), "*") + "\custom_levels\\full_level_map_" + global.level_name + ".png", "\\", "/");
