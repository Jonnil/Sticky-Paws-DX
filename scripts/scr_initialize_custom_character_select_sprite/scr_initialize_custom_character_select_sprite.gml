...
function scr_initialize_custom_character_select_sprite(argument0, argument1, argument2, argument3)
{
	...
	or (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[argument2])) + "/data/sprite_origin_point.ini"))
	{
		if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[argument2])) + "/data/sprite_origin_point.ini"))
		{
		...
		if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[argument2])) + "/data/sprite_origin_point.ini"))
		{
