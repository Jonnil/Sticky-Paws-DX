...
function scr_initialize_custom_character_select_sprite(argument0, argument1, argument2, argument3)
{
	...
	/*argument2. Player variable, ususally type "argument2"*/
	...
	and (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[argument2])) + "/data/sprite_origin_point.ini"))
	{
		ini_open(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[argument2])) + "/data/sprite_origin_point.ini");
		...
		ini_open(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[argument2])) + "/data/unused_sprite_origin_point.ini");
