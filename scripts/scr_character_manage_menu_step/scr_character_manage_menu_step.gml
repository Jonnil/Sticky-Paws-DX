function scr_character_manage_menu_step()
{
	...
	if (skin0_required)
	and (!directory_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[0])) + "/sprites/skin0"))
	{
	...
	or (menu == "back_from_copy_character")
	{
		...
		{
			menu_specific_joystick_delay[1] -= 1;
		}
		...
		and (menu_delay == 0)
		and (can_navigate)
		or (player_menu[1] = "click_delete_character")
		and (key_a_pressed)
		and (menu_delay == 0)
		and (can_navigate)
		{
		...
		and (menu_delay == 0)
		and (can_navigate)
		or (player_menu[1] = "click_delete_character_no")
		and (key_a_pressed)
		and (menu_delay == 0)
		and (can_navigate)
		{
		...
		and (menu_delay == 0)
		and (can_navigate)
		or (player_menu[1] = "click_delete_character_yes")
		and (key_a_pressed)
		and (menu_delay == 0)
		and (can_navigate)
		{
		...
		and (menu_delay == 0)
		and (can_navigate)
		or (player_menu[1] = "open_folder_copy_character")
		and (key_a_pressed)
		and (menu_delay == 0)
		and (can_navigate)
		{
		...
		and (menu_delay == 0)
		and (can_navigate)
		or (player_menu[1] = "back_from_copy_character")
		and (key_a_pressed)
		and (menu_delay == 0)
		and (can_navigate)
		or (key_b_pressed)
