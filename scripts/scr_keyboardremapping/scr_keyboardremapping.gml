...
function scr_keyboardremapping(menu_string, remap_key_number, remapping_key)
{
	...
	and (menu_remap_key_number = remap_key_number)
	{
		if (menu = menu_string)
		{
			remapping_key = last_key;
		}
		can_remap_key = false;
		input_key = false;
		menu_delay = 10;
		with(instance_create_depth(640, 320, 0, obj_scoreup))
		{
			scoreup = string(remapping_key)
		}
	}
	#endregion /*Remapping END*/
	
	return remapping_key
