function scr_set_default_language()
{
	if (file_exists("localization.csv"))
	{
		...
		for (var i = 1; i < num_languages; i++;)
		{
			...
			&& (global.language_local_data[# i, 0] == "English")
			|| (os_get_language() == "ja"
			|| switch_languages == "ja")
			&& (global.language_local_data[# i, 0] == "日本語 (Japanese)")
			|| (os_get_language() == "pl"
			|| switch_languages == "pl")
			&& (global.language_local_data[# i, 0] == "Polski (Polish)")
			|| (os_get_language() == "es"
			|| switch_languages == "es")
			&& (global.language_local_data[# i, 0] == "Español (Spanish)")
			|| (os_get_language() == "sv"
			|| switch_languages == "sv")
			&& (global.language_local_data[# i, 0] == "Svenska (Swedish)")
			{
