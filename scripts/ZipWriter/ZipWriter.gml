...
//function zip_create(_compressionLevel = -1){
...
//function zip_add_buffer_ext(_this,_path1,_buf,_pos,_len,_compressionLevel = -1){
...
//function zip_add_buffer(_this,_path1,_buf,_compressionLevel = -1)
//{
...
//function zip_add_file(_this, _path1, _filePath, _compressionLevel = -1)
//{
//	if(false)show_debug_message(argument[2]);
