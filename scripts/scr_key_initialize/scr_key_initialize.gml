function scr_key_initialize(key, hold0_press1_release2 = 0, what_player = 1, this_player_key = action.jump)
{
	...
	if (gp_button_value1 != noone) {
		...
		if (axis_index != noone) {
			if (axis_direction == -1) {
				joy_1 = gamepad_axis_value(player_slot, axis_index) < -0.3;
			}
			else {
				joy_1 = gamepad_axis_value(player_slot, axis_index) > +0.3;
			}
	...
	if (gp_button_value2 != noone) {
		...
		if (axis_index != noone) {
			if (axis_direction == -1) {
				joy_2 = gamepad_axis_value(player_slot, axis_index) < -0.3;
			}
			else {
				joy_2 = gamepad_axis_value(player_slot, axis_index) > +0.3;
			}
	...
	if (hold0_press1_release2 == 0) {
		gp_other = (gp_button_value1 != noone && gamepad_button_check(player_slot, gp_button_value1)) || (gp_button_value2 != noone && gamepad_button_check(player_slot, gp_button_value2));
	}
	else
	if (hold0_press1_release2 == 1) {
		gp_other = (gp_button_value1 != noone && gamepad_button_check_pressed(player_slot, gp_button_value1)) || (gp_button_value2 != noone && gamepad_button_check_pressed(player_slot, gp_button_value2));
	}
	else
	if (hold0_press1_release2 == 2) {
		gp_other = (gp_button_value1 != noone && gamepad_button_check_released(player_slot, gp_button_value1)) || (gp_button_value2 != noone && gamepad_button_check_released(player_slot, gp_button_value2));
	}
	
	if (hold0_press1_release2 == 0) {
		key_other = (button_value1 != noone && keyboard_check(button_value1)) || (button_value2 != noone && keyboard_check(button_value2));
	}
	else
	if (hold0_press1_release2 == 1) {
		key_other = (button_value1 != noone && keyboard_check_pressed(button_value1)) || (button_value2 != noone && keyboard_check_pressed(button_value2));
	}
	else
	if (hold0_press1_release2 == 2) {
		key_other = (button_value1 != noone && keyboard_check_released(button_value1)) || (button_value2 != noone && keyboard_check_released(button_value2));
	}
	
	return key_mouse || key2_mouse || joy_1 || joy_2 || key_other || gp_other;
}