function scr_set_default_remapping_player4_keyboard(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config == true)
	{
		...
		ini_write_real("config", "player4_key_double_jump", global.player_[inp.key][4][1][action.double_jump]);
		ini_write_real("config", "player4_key2_double_jump", global.player_[inp.key][4][2][action.double_jump]);
