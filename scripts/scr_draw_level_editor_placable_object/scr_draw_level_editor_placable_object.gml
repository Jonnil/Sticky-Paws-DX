function scr_draw_level_editor_placable_object(var_selected_object, var_place_object_id, var_can_make_place_brush_size_bigger, var_sprite_index, var_mask_index, var_scroll_x, var_scale, var_rotation, var_color, var_scroll_y = 0, var_x_offset = 0, alpha_offset = 1, add_order_index = 1, object_description = "")
{
	...
	if (unlocked_object[var_place_object_id] >= true)
	{
		...
		draw_sprite_ext(var_sprite_index, 0, view_center_x + selected_object_menu_x + var_scroll_x * var_selected_object + var_x_offset, cam_y + y_offset + var_scroll_y, var_scale * var_scale_modify, var_scale * var_scale_modify, var_rotation, var_color, selected_menu_alpha * alpha_offset);
		if (unlocked_object[var_place_object_id] == 1)
		&& (global.show_new_items_notification)
		{
			scr_draw_text_outlined(view_center_x + selected_object_menu_x + var_scroll_x * var_selected_object, cam_y + y_offset, l10n_text("New"), global.default_text_size + scr_wave(-0.3, -0.2, 1, 0), c_white, c_red, selected_menu_alpha * alpha_offset);
		}
