...
function draw_menu_button(x_position, y_position, string_text, menu_index, menu_takes_you_to)
{
	...
	and (global.controls_used_for_menu_navigation = "controller")
	{
		...
		{
			draw_text_outlined(x_position + 185, y_position + 21, string(string_text), global.default_text_size * 0.7, c_black, c_white, 1); /*White text inside the menu button*/
		}
		else
		{
			draw_text_outlined(x_position + 185, y_position + 21, string(string_text), global.default_text_size, c_black, c_white, 1); /*White text inside the menu button*/
		}
	...
	else
	{
		...
		if (string_width(string_text) >= 360)
		{
			draw_text_outlined(x_position + 185, y_position + 21, string(string_text), global.default_text_size * 0.7, c_white, c_black, 1); /*Black text inside the menu button*/
		}
		else
		{
			draw_text_outlined(x_position + 185, y_position + 21, string(string_text), global.default_text_size, c_white, c_black, 1); /*Black text inside the menu button*/
		}
	}
