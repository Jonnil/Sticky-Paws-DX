...
function draw_menu_button()
{
	...
	if (point_in_rectangle(mouse_x,mouse_y,x_position,y_position+1,x_position+370,y_position+41))
	...
	if (point_in_rectangle(mouse_x,mouse_y,x_position,y_position,x_position+370,y_position+42))
	{
