function scr_set_default_remapping_player1_gamepad(save_default_controls_to_config = false)
{
	...
	global.player_[inp.gp][1][1][action.sprint] = gp_face3;
	global.player_[inp.gp][1][1][action.sprint_toggle] = noone;
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button_sprint", global.player_[inp.gp][1][1][action.sprint]);
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button2_sprint", global.player_[inp.gp][1][2][action.sprint]);
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button_sprint_toggle", global.player_[inp.gp][1][1][action.sprint_toggle]);
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button2_sprint_toggle", global.player_[inp.gp][1][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player1_keyboard(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_key_sprint", global.player_[inp.key][1][1][action.sprint]);
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_key2_sprint", global.player_[inp.key][1][2][action.sprint]);
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_key_sprint_toggle", global.player_[inp.key][1][1][action.sprint_toggle]);
		ini_write_real("player1_profile" + string(global.player1_profile), "player1_key2_sprint_toggle", global.player_[inp.key][1][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player2_gamepad(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button_sprint", global.player_[inp.gp][2][1][action.sprint]);
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button2_sprint", global.player_[inp.gp][2][2][action.sprint]);
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button_sprint_toggle", global.player_[inp.gp][2][1][action.sprint_toggle]);
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button2_sprint_toggle", global.player_[inp.gp][2][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player2_keyboard(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_key_sprint", global.player_[inp.key][2][1][action.sprint]);
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_key2_sprint", global.player_[inp.key][2][2][action.sprint]);
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_key_sprint_toggle", global.player_[inp.key][2][1][action.sprint_toggle]);
		ini_write_real("player2_profile" + string(global.player2_profile), "player2_key2_sprint_toggle", global.player_[inp.key][2][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player3_gamepad(save_default_controls_to_config = false)
{
	...
	global.player_[inp.gp][3][1][action.sprint] = gp_face3;
	global.player_[inp.gp][3][1][action.sprint_toggle] = noone;
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button_sprint", global.player_[inp.gp][3][1][action.sprint]);
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button2_sprint", global.player_[inp.gp][3][2][action.sprint]);
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button_sprint_toggle", global.player_[inp.gp][3][1][action.sprint_toggle]);
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button2_sprint_toggle", global.player_[inp.gp][3][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player3_keyboard(save_default_controls_to_config = false)
{
	...
	global.player_[inp.key][3][1][action.sprint] = noone;
	global.player_[inp.key][3][1][action.sprint_toggle] = noone;
	...
	global.player_[inp.key][3][2][action.sprint] = noone;
	global.player_[inp.key][3][2][action.sprint_toggle] = noone;
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_key_sprint", global.player_[inp.key][3][1][action.sprint]);
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_key2_sprint", global.player_[inp.key][3][2][action.sprint]);
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_key_sprint_toggle", global.player_[inp.key][3][1][action.sprint_toggle]);
		ini_write_real("player3_profile" + string(global.player3_profile), "player3_key2_sprint_toggle", global.player_[inp.key][3][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player4_gamepad(save_default_controls_to_config = false)
{
	...
	global.player_[inp.gp][4][1][action.sprint] = gp_face3;
	global.player_[inp.gp][4][1][action.sprint_toggle] = noone;
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button_sprint", global.player_[inp.gp][4][1][action.sprint]);
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button2_sprint", global.player_[inp.gp][4][2][action.sprint]);
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button_sprint_toggle", global.player_[inp.gp][4][1][action.sprint_toggle]);
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button2_sprint_toggle", global.player_[inp.gp][4][2][action.sprint_toggle]);
...
function scr_set_default_remapping_player4_keyboard(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config)
	{
		...
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_key_sprint", global.player_[inp.key][4][1][action.sprint]);
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_key2_sprint", global.player_[inp.key][4][2][action.sprint]);
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_key_sprint_toggle", global.player_[inp.key][4][1][action.sprint_toggle]);
		ini_write_real("player4_profile" + string(global.player4_profile), "player4_key2_sprint_toggle", global.player_[inp.key][4][2][action.sprint_toggle]);
