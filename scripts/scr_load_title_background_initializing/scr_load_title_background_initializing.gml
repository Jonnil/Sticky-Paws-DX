function scr_load_title_background_initializing()
{
	...
	first_title_background = string(file_find_first(working_directory + "custom_title_background/*", fa_directory))
	if (file_exists(working_directory + "custom_title_background/" + first_title_background))
	{
