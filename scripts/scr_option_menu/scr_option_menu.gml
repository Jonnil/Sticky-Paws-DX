			...
			if (capture_mode_menu_active)
			{
				...
				if (capture_mode_recording_checklist_menu_active)
				{
					...
					var capture_checklist_body_text = l10n_text("Game setup")
						+ "\n"
						+ l10n_text("1. For handheld footage, choose Handheld Capture: exactly 1280 x 720 (720p) at 60 FPS.")
						+ "\n"
				...
				if (!capture_mode_confirmation_menu_active)
				{
					...
					var review_switch_capture_mode = draw_menu_button(capture_button_x, capture_switch_y, l10n_text("Handheld Capture: 1280 x 720 (60 FPS)"), "capture_mode_switch", "", c_red, 1, capture_button_width);
					var capture_tutorial_signs_visible = scr_capture_mode_get_tutorial_signs_visible();
					...
					if (menu == "capture_mode_switch")
					{
						global.option_description = global.enable_option_for_pc
							? l10n_text("Reviews the required 1280 x 720, 60 FPS handheld recording preset")
