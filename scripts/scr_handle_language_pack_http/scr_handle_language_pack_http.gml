...
function scr_handle_language_pack_http(_async_map)
{
	...
	if (req_id == global.language_http_request_id)
	{
		...
		/* We now assume that the manifest is CSV, regardless of its header */
		...
		show_debug_message("[scr_handle_language_pack_http] Processing CSV manifest. language_last_update_string = " 
