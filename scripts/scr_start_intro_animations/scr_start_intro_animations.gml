	...
	and (global.y_checkpoint <= 0)
	{
		...
		and (global.current_level_clear_rate = "enter")
		{
			...
			if (cutscene_time = 60 * 2)
			{
				...
				audio_sound_gain(voice_open_mouth, global.voices_volume * global.main_volume, 0);
			...
			if (cutscene_time = 60 * 3.5)
			{
				...
				audio_sound_gain(voice_notice, global.voices_volume * global.main_volume, 0);
			...
			if (cutscene_time = 60 * 4.2)
			{
				...
				audio_sound_gain(voice_scream, global.voices_volume * global.main_volume, 0);
