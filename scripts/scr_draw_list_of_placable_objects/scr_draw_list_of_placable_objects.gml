		...
		&& (quit_level_editor <= 0)
		{
			...
			*/
			...
			var objects = [
				...
				{ o_id: LEVEL_OBJECT_ID.ID_FALLING_BLOCK_LONG, o_can_make_bigger: true, o_sprite: spr_falling_block_long, o_mask: spr_cardboard, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: -24, o_alpha: 1, o_add_order_index: 1, o_name: "Falling Block Long", o_description: "Falls shortly after you stand on them for too long", o_image_index: 0, o_category: "terrain", o_daily_build_category: "daily_build_featured" },
				...
				{ o_id: LEVEL_OBJECT_ID.ID_INSTANT_FALLING_BLOCK_LONG, o_can_make_bigger: true, o_sprite: spr_instant_falling_block_long, o_mask: spr_cardboard, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: -24, o_alpha: 1, o_add_order_index: 1, o_name: "Instant Falling Block Long", o_description: "Falls shortly after you stand on them for too long", o_image_index: 0, o_category: "terrain", o_daily_build_category: "daily_build_featured" },
				...
				{ o_id: LEVEL_OBJECT_ID.ID_WOOD_FALLING_BLOCK_LONG, o_can_make_bigger: true, o_sprite: spr_wood_falling_block_long, o_mask: spr_cardboard, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: -24, o_alpha: 1, o_add_order_index: 1, o_name: "Wood Falling Block Long", o_description: "Falls shortly after you stand on them for too long", o_image_index: 0, o_category: "terrain", o_daily_build_category: "daily_build_featured" },
				...
				{ o_id: LEVEL_OBJECT_ID.ID_STONE_FALLING_BLOCK_LONG, o_can_make_bigger: true, o_sprite: spr_stone_falling_block_long, o_mask: spr_cardboard, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: -24, o_alpha: 1, o_add_order_index: 1, o_name: "Stone Falling Block Long", o_description: "Falls shortly after you stand on them for too long", o_image_index: 0, o_category: "terrain", o_daily_build_category: "daily_build_featured" },
				...
				{ o_id: LEVEL_OBJECT_ID.ID_CARDBOARD, o_can_make_bigger: true, o_sprite: spr_cardboard, o_mask: spr_cardboard, o_scroll_x: +100, o_scale: 0.75, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: -16, o_alpha: 1, o_add_order_index: 1, o_name: "Cardboard", o_description: "", o_image_index: 0, o_category: "terrain", o_daily_build_category: "daily_build_standard" },
				{ o_id: LEVEL_OBJECT_ID.ID_CARDBOARD_LONG, o_can_make_bigger: true, o_sprite: spr_cardboard_long, o_mask: spr_cardboard_long, o_scroll_x: +100, o_scale: 0.5, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: -24, o_alpha: 1, o_add_order_index: 1, o_name: "Long Cardboard", o_description: "", o_image_index: 0, o_category: "terrain", o_daily_build_category: "daily_build_standard" },
				...
				/* Category: Gizmo */
				{ o_id: LEVEL_OBJECT_ID.ID_BLASTER, o_can_make_bigger: true, o_sprite: global.resource_pack_sprite_blaster, o_mask: spr_wall, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: 0, o_alpha: 1, o_add_order_index: 1, o_name: "Rat Blaster", o_description: "", o_image_index: 0, o_category: "gizmo", o_daily_build_category: "daily_build_featured" },
				...
				{ o_id: LEVEL_OBJECT_ID.ID_CHECKPOINT, o_can_make_bigger: false, o_sprite: spr_checkpoint_activated, o_mask: spr_wall, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: 0, o_alpha: 1, o_add_order_index: 1, o_name: "Checkpoint", o_description: "", o_image_index: 0, o_category: "gizmo", o_daily_build_category: "daily_build_standard" },
				...
				{ o_id: LEVEL_OBJECT_ID.ID_BUMP_IN_GROUND, o_can_make_bigger: true, o_sprite: spr_bump_in_ground, o_mask: spr_wall, o_scroll_x: +100, o_scale: 1, o_rotation: 0, o_color: c_white, o_scroll_y: 0, o_x_offset: 0, o_alpha: 1, o_add_order_index: 1, o_name: "Bump in Ground", o_description: "", o_image_index: 0, o_category: "gizmo", o_daily_build_category: "daily_build_standard" },
