...
function scr_options_menu(){
	...
	/*Click Back*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,0-room_height,370,40-1))and(global.settings_sidebar_menu="settings_back")and(mouse_check_button_released(mb_left)){in_settings=false;menu="options";menu_delay=10;}else
	/*Back*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,0-room_height,370,40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="settings_back";can_navigate_settings_sidebar=true;}else
	...
	/*Accessibility*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,accessibility_settings_y,370,(accessibility_settings_y+40)-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="accessibility_settings";can_navigate_settings_sidebar=true;}else
	...
	/*Game*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,game_settings_y,370,(game_settings_y+40)-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="game_settings";can_navigate_settings_sidebar=true;}
	...
	if (global.enable_multiplayer_settings = true)
	{
		...
		/*Multiplayer*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,multiplayer_settings_y,370,multiplayer_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="multiplayer_settings";can_navigate_settings_sidebar=true;}
	}
	...
	/*Keyboard and Mouse*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,keyboard_and_mouse_settings_y,370,keyboard_and_mouse_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="keyboard_and_mouse_settings";can_navigate_settings_sidebar=true;}
	...
	if(global.enable_controller_settings = true)
	{
		...
		/*Controller*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,controller_settings_y,370,controller_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="controller_settings";can_navigate_settings_sidebar=true;}
	}
	...
	if(global.enable_touch_settings = true)
	{
		...
		/*Touch*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,touch_settings_y,370,touch_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="touch_settings";can_navigate_settings_sidebar=true;}
	}
	...
	if(global.enable_profile_settings = true)
	{
		...
		/*Profile*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,profile_settings_y,370,profile_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="profile_settings";can_navigate_settings_sidebar=true;}
	}
	...
	/*Video*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,video_settings_y,370,video_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="video_settings";can_navigate_settings_sidebar=true;}
	...
	/*Audio*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,audio_settings_y,370,audio_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="audio_settings";can_navigate_settings_sidebar=true;}
	...
	if(global.enable_global_resources_settings = true)
	{
		...
		/*Global Resources*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,global_resources_settings_y,370,global_resources_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="global_resources_settings";can_navigate_settings_sidebar=true;}
	}
	...
	if(global.enable_storage_settings = true)
	{
		...
		/*Storage*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,storage_settings_y,370,storage_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="storage_settings";can_navigate_settings_sidebar=true;}
	}
	...
	if(global.enable_language_settings = true)
	{
		...
		/*Language*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,language_settings_y,370,language_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="language_settings";can_navigate_settings_sidebar=true;}
	}
	...
	if(global.enable_broadcast_settings = true)
	{
		...
		/*Broadcast*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,broadcast_settings_y,370,broadcast_settings_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="broadcast_settings";can_navigate_settings_sidebar=true;}
	}
	...
	if(global.enable_how_to_play_settings = true)
	{
		...
		/*How to Play*/if (point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),0-room_width,how_to_play_y,370,how_to_play_y+40-1))and(mouse_check_button(mb_left)){global.settings_sidebar_menu="how_to_play";can_navigate_settings_sidebar=true;}
	}
	...
	if (global.settings_sidebar_menu="accessibility_settings")
	{
		...
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+accessibility_settings_y,1,1,0,c_green,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+accessibility_settings_y,1,1,0,c_gray,1);
		}
		/*Button Hightlighted*/
		
		draw_sprite_ext(spr_settings_icons,1,20+icon_x_offset,20+accessibility_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+accessibility_settings_y,Text("Accessibility"),global.default_text_size*1.1,c_black,c_white,1);
		if (key_up)
		and(can_navigate_settings_sidebar=true)
		and(menu_delay=0)
		{
	...
	else
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+accessibility_settings_y,1,1,0,c_lime,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+accessibility_settings_y,1,1,0,c_white,1);
		}
		draw_sprite_ext(spr_settings_icons,1,20+icon_x_offset,20+accessibility_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+accessibility_settings_y,Text("Accessibility"),global.default_text_size,c_white,c_black,1);
	}
	#endregion /*Accessibility Settings END*/
	
	#region /*My Game Settings*/
	draw_text_outlined(20+text_x_offset,20+(game_text_y),Text("Game"),global.default_text_size*0.5,c_black,c_white,1);
	...
	if (global.settings_sidebar_menu="game_settings")
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+game_settings_y,1,1,0,c_green,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+game_settings_y,1,1,0,c_gray,1);
		}
		draw_sprite_ext(spr_settings_icons,2,20+icon_x_offset,20+game_settings_y,1,1,0,c_white,1) /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+game_settings_y,Text("Game"),global.default_text_size*1.1,c_black,c_white,1);
		if (key_up)
		and(can_navigate_settings_sidebar=true)
		and(menu_delay=0)
		{
	...
	else
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+game_settings_y,1,1,0,c_lime,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+game_settings_y,1,1,0,c_white,1);
		}
		draw_sprite_ext(spr_settings_icons,2,20+icon_x_offset,20+game_settings_y,0.9,0.9,0,c_white,1)
		draw_text_outlined(40+text_x_offset,20+game_settings_y,Text("Game"),global.default_text_size,c_white,c_black,1);
	}
	...
	if(global.enable_multiplayer_settings = true)
	{
		if (global.settings_sidebar_menu="multiplayer_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+multiplayer_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+multiplayer_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,3,20+icon_x_offset,20+multiplayer_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+multiplayer_settings_y,Text("Multiplayer"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+multiplayer_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+multiplayer_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,3,20+icon_x_offset,20+multiplayer_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+multiplayer_settings_y,Text("Multiplayer"),global.default_text_size,c_white,c_black,1);}
	}
	...
	draw_text_outlined(20+text_x_offset,20+(controls_text_y),Text("Controls"),global.default_text_size*0.5,c_black,c_white,1);
	...
	if (global.settings_sidebar_menu="keyboard_and_mouse_settings")
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+keyboard_and_mouse_settings_y,1,1,0,c_green,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+keyboard_and_mouse_settings_y,1,1,0,c_gray,1);
		}
		draw_sprite_ext(spr_settings_icons,4,20+icon_x_offset,20+keyboard_and_mouse_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+keyboard_and_mouse_settings_y,Text("Keyboard & Mouse"),global.default_text_size*1.1,c_black,c_white,1);
		if (key_up)
		and(can_navigate_settings_sidebar=true)
		and(menu_delay=0)
		{
	...
	else
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+keyboard_and_mouse_settings_y,1,1,0,c_lime,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+keyboard_and_mouse_settings_y,1,1,0,c_white,1);
		}
	draw_sprite_ext(spr_settings_icons,4,20+icon_x_offset,20+keyboard_and_mouse_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
	draw_text_outlined(40+text_x_offset,20+keyboard_and_mouse_settings_y,Text("Keyboard & Mouse"),global.default_text_size,c_white,c_black,1);}
	...
	if(global.enable_controller_settings = true)
	{
		if (global.settings_sidebar_menu="controller_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+controller_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+controller_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,5,20+icon_x_offset,20+controller_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+controller_settings_y,Text("Controller"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+controller_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+controller_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,5,20+icon_x_offset,20+controller_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+controller_settings_y,Text("Controller"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if(global.enable_touch_settings = true)
	{
		if (global.settings_sidebar_menu="touch_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+touch_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+touch_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,6,20+icon_x_offset,20+touch_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+touch_settings_y,Text("Touch"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+touch_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+touch_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,6,20+icon_x_offset,20+touch_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+touch_settings_y,Text("Touch"),global.default_text_size,c_white,c_black,1);}
	}
	...
	draw_text_outlined(20+text_x_offset,20+general_text_y,Text("General"),global.default_text_size*0.5,c_black,c_white,1);
	...
	if(global.enable_profile_settings = true)
	{
		if (global.settings_sidebar_menu="profile_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+profile_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+profile_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,7,20+icon_x_offset,20+profile_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+profile_settings_y,Text("Profile"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+profile_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+profile_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,7,20+icon_x_offset,20+profile_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+profile_settings_y,Text("Profile"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if (global.settings_sidebar_menu="video_settings")
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+video_settings_y,1,1,0,c_green,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+video_settings_y,1,1,0,c_gray,1);
		}
		draw_sprite_ext(spr_settings_icons,8,20+icon_x_offset,20+video_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+video_settings_y,Text("Video"),global.default_text_size*1.1,c_black,c_white,1);
		if (key_up)
		and(can_navigate_settings_sidebar=true)
		and(menu_delay=0)
		{
	...
	else
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+video_settings_y,1,1,0,c_lime,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+video_settings_y,1,1,0,c_white,1);
		}
	draw_sprite_ext(spr_settings_icons,8,20+icon_x_offset,20+video_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
	draw_text_outlined(40+text_x_offset,20+video_settings_y,Text("Video"),global.default_text_size,c_white,c_black,1);}
	...
	if (global.settings_sidebar_menu="audio_settings")
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+audio_settings_y,1,1,0,c_green,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+audio_settings_y,1,1,0,c_gray,1);
		}
	draw_sprite_ext(spr_settings_icons,9,20+icon_x_offset,20+audio_settings_y,1,1,0,c_white,1); /*Settings Icon*/
	draw_text_outlined(40+text_x_offset,20+audio_settings_y,Text("Audio"),global.default_text_size*1.1,c_black,c_white,1);
	if (key_up)
	and(can_navigate_settings_sidebar=true)
	and(menu_delay=0)
	{
		global.settings_sidebar_menu="video_settings";
		menu_delay=10;
	}else if (key_down)and(can_navigate_settings_sidebar=true)and(menu_delay=0){
		if (global.enable_global_resources_settings = true){global.settings_sidebar_menu="global_resources_settings";}
		else if (global.enable_storage_settings = true){global.settings_sidebar_menu="storage_settings";}
		else if (global.enable_language_settings = true){global.settings_sidebar_menu="language_settings";}
		else if (global.enable_broadcast_settings = true){global.settings_sidebar_menu="broadcast_settings";}
		else if (global.enable_how_to_play_settings = true){global.settings_sidebar_menu="how_to_play_settings";}
		else if (global.enable_add_ons_settings = true){global.settings_sidebar_menu="resource_packs_settings";}
		else{global.settings_sidebar_menu="settings_back";}
	...
	else
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+audio_settings_y,1,1,0,c_lime,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+audio_settings_y,1,1,0,c_white,1);
		}
	draw_sprite_ext(spr_settings_icons,9,20+icon_x_offset,20+audio_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
	draw_text_outlined(40+text_x_offset,20+audio_settings_y,Text("Audio"),global.default_text_size,c_white,c_black,1);}
	...
	if(global.enable_global_resources_settings = true)
	{
		if (global.settings_sidebar_menu="global_resources_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+global_resources_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+global_resources_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,10,20+icon_x_offset,20+global_resources_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+global_resources_settings_y,Text("Custom Resources"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+global_resources_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+global_resources_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,10,20+icon_x_offset,20+global_resources_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+global_resources_settings_y,Text("Custom Resources"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if(global.enable_storage_settings = true)
	{
		if (global.settings_sidebar_menu="storage_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+storage_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+storage_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,11,20+icon_x_offset,20+storage_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+(40*14),Text("Storage"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+storage_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+storage_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,11,20+icon_x_offset,20+storage_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+storage_settings_y,Text("Storage"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if(global.enable_language_settings = true)
	{
		if (global.settings_sidebar_menu="language_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+language_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+language_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,12,20+icon_x_offset,20+language_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+language_settings_y,Text("Language"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+language_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+language_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,12,20+icon_x_offset,20+language_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+language_settings_y,Text("Language"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if(global.enable_broadcast_settings = true)
	{
		if (global.settings_sidebar_menu="broadcast_settings")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+broadcast_settings_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+broadcast_settings_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,13,20+icon_x_offset,20+broadcast_settings_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+broadcast_settings_y,Text("Broadcast"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+broadcast_settings_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+broadcast_settings_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,13,20+icon_x_offset,20+broadcast_settings_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+broadcast_settings_y,Text("Broadcast"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if(global.enable_how_to_play_settings = true)
	{
		if (global.settings_sidebar_menu="how_to_play")
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+how_to_play_y,1,1,0,c_green,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+how_to_play_y,1,1,0,c_gray,1);
			}
		draw_sprite_ext(spr_settings_icons,14,20+icon_x_offset,20+how_to_play_y,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+how_to_play_y,Text("How to Play"),global.default_text_size*1.1,c_black,c_white,1);
		...
		else
		{
			...
			and(global.controls_used_for_menu_navigation="mouse")
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+how_to_play_y,1,1,0,c_lime,1);
			}
			else
			{
				draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+how_to_play_y,1,1,0,c_white,1);
			}
		draw_sprite_ext(spr_settings_icons,14,20+icon_x_offset,20+how_to_play_y,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+how_to_play_y,Text("How to Play"),global.default_text_size,c_white,c_black,1);}
	}
	...
	{
		draw_text_outlined(20+text_x_offset,20+(40*18),Text("Add-Ons"),global.default_text_size*0.5,c_black,c_white,1);

		if (global.settings_sidebar_menu="resource_packs_settings")
		{draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+(40*19),1,1,0,c_gray,1); /*Button Hightlighted*/
		draw_sprite_ext(spr_settings_icons,15,20+icon_x_offset,20+(40*19),1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+(40*19),Text("Resource Packs"),global.default_text_size*1.1,c_black,c_white,1);
		if (key_up)
		and(can_navigate_settings_sidebar=true)
		and(menu_delay=0)
		{
		...
		}else{draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+(40*19),1,1,0,c_white,1); /*Button Not Selected*/
		draw_sprite_ext(spr_settings_icons,15,20+icon_x_offset,20+(40*19),0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+(40*19),Text("Resource Packs"),global.default_text_size,c_white,c_black,1);}

		if (global.settings_sidebar_menu="behavior_packs_settings")
		{draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+(40*20),1,1,0,c_gray,1); /*Button Hightlighted*/
		draw_sprite_ext(spr_settings_icons,16,20+icon_x_offset,20+(40*20),1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+(40*20),Text("Behavior Packs"),global.default_text_size*1.1,c_black,c_white,1);
		...
		}else{draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20+(40*20),1,1,0,c_white,1); /*Button Not Selected*/
		draw_sprite_ext(spr_settings_icons,16,20+icon_x_offset,20+(40*20),0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20+(40*20),Text("Behavior Packs"),global.default_text_size,c_white,c_black,1);}
	}
	...
	if (global.settings_sidebar_menu="settings_back")
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20,1,1,0,c_green,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20,1,1,0,c_gray,1);
		}
		/*Button Hightlighted*/
		
		draw_sprite_ext(spr_settings_icons,0,20+icon_x_offset,20,1,1,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20,Text("Back"),global.default_text_size*1.1,c_black,c_white,1);
		if (key_up)
		and(can_navigate_settings_sidebar=true)
		and(menu_delay=0)
		{
	...
	else
	{
		...
		and(global.controls_used_for_menu_navigation="mouse")
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20,1,1,0,c_lime,1);
		}
		else
		{
			draw_sprite_ext(spr_menu_button,0,camera_get_view_x(view_camera[view_current]),20,1,1,0,c_white,1);
		}
		/*Button Not Selected*/
		
		draw_sprite_ext(spr_settings_icons,0,20+icon_x_offset,20,0.9,0.9,0,c_white,1); /*Settings Icon*/
		draw_text_outlined(40+text_x_offset,20,Text("Back"),global.default_text_size,c_white,c_black,1);
	}
...
if (global.settings_sidebar_menu = "accessibility_settings")
{
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_dive+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_dive,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_dive+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_jump+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_jump,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_jump+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_crouch+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_crouch,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_crouch+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_crouch_toggle+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_crouch_toggle,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_crouch_toggle+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_sprint+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_sprint,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_sprint+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_sprint_toggle+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_sprint_toggle,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_sprint_toggle+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_left+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_left,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_left+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_right+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_right,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_right+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_down+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_down,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_down+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_up+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_up,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_up+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	and(menu_remap_key_number=0)
	{
		...
		camera_get_view_width(view_camera[view_current])/2+224,
		menu_y_remap_key_attack+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key_attack,camera_get_view_width(view_camera[view_current])/2+224,menu_y_remap_key_attack+menu_y_offset,0.9,0.9,0,c_gray,0.9);
	}
	...
	if (menu="remap_key_dive")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_dive,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_dive+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_dive,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_dive+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_jump")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_jump,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_jump+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_jump,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_jump+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_crouch")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_crouch,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_crouch+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_crouch,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_crouch+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_crouch_toggle")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_crouch_toggle,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_crouch_toggle+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_crouch_toggle,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_crouch_toggle+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_sprint")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_sprint,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_sprint+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_sprint,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_sprint+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_sprint_toggle")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_sprint_toggle,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_sprint_toggle+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_sprint_toggle,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_sprint_toggle+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_left")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_left,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_left+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_left,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_left+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_right")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_right,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_right+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_right,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_right+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_down")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_down,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_down+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_down,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_down+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_up")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_up,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_up+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_up,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_up+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	if (menu="remap_key_attack")and(menu_remap_key_number=2){draw_sprite_ext(spr_keyboard_keys,global.player1_key2_attack,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_attack+menu_y_offset,1,1,0,c_white,1);}else{draw_sprite_ext(spr_keyboard_keys,global.player1_key2_attack,camera_get_view_width(view_camera[view_current])/2+352,menu_y_remap_key_attack+menu_y_offset,0.9,0.9,0,c_gray,0.9);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_dive+menu_y_offset,"Dive",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_jump+menu_y_offset,"Jump",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_crouch+menu_y_offset,"Crouch",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_crouch_toggle+menu_y_offset,"Crouch Toggle",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_sprint+menu_y_offset,"Sprint",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_sprint_toggle+menu_y_offset,"Sprint Toggle",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_left+menu_y_offset,"Left",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_right+menu_y_offset,"Right",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_down+menu_y_offset,"Down",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_up+menu_y_offset,"Up",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	...
	if (input_key=true)and(can_remap_key=false){menu_delay=10;scr_keyboardremapping();}else if (key_a)and(menu_delay=0){menu_delay=10;input_key=true;}}else{draw_text_outlined(410,menu_y_remap_key_attack+menu_y_offset,"Tongue",global.default_text_size,c_menu_outline,c_menu_fill,1);}
	#endregion /*Remap Key Up End*/
	...
	if (menu="remap_reset"){draw_sprite_ext(spr_menu_cursor,menu_cursor_index,390,menu_y_remap_reset+menu_y_offset,1,1,0,c_white,1);menu_cursor_y_position=menu_y_remap_reset;
	draw_sprite_ext(spr_menu_button,0,410,menu_y_remap_reset+menu_y_offset,1,1,0,c_white,1);
	draw_text_outlined(420,menu_y_remap_reset+menu_y_offset,"Default Settings",global.default_text_size*1.1,c_menu_outline,c_menu_fill,1);
	if (key_a)
	and(menu_delay=0)
	{
	...
	{
		draw_sprite_ext(spr_menu_button,0,410,menu_y_remap_reset+menu_y_offset,1,1,0,c_white,1);
		draw_text_outlined(420,menu_y_remap_reset+menu_y_offset,"Default Settings",global.default_text_size,c_menu_outline,c_menu_fill,1);
	}
	...
	{draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+170,"> Convention Mode: True",global.default_text_size*1.1,c_menu_outline,c_menu_fill,1);draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+190,"Puts the game in a special convention mode for event showcasing",global.default_text_size*0.5,c_menu_outline,c_menu_fill,1);}
	else{draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+170,"> Convention Mode: False",global.default_text_size*1.1,c_menu_outline,c_menu_fill,1);draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+190,"Puts the game in a special convention mode for event showcasing",global.default_text_size*0.5,c_menu_outline,c_menu_fill,1);}}else
	if (global.convention_mode=true)
	{draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+170,"Convention Mode: True",global.default_text_size,c_menu_outline,c_menu_fill,1);draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+190,"Puts the game in a special convention mode for event showcasing",global.default_text_size*0.5,c_menu_outline,c_menu_fill,1);}
	else{draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+170,"Convention Mode: False",global.default_text_size,c_menu_outline,c_menu_fill,1);draw_text_outlined(camera_get_view_width(view_camera[view_current])/2,camera_get_view_height(view_camera[view_current])/2+menu_y_offset+190,"Puts the game in a special convention mode for event showcasing",global.default_text_size*0.5,c_menu_outline,c_menu_fill,1);}
