function scr_draw_caution_online()
{
	...
	|| (menu == "caution_online_proceed")
	{
		...
		&& (menu_delay == 0 && menu_joystick_delay == 0)
		{
			...
			if (scr_begin_user_online_flow(caution_online_takes_you_to, caution_online_takes_you_back_to, content_type, "scr_draw_caution_online"))
			{
				scr_finish_prepared_user_online_flow("scr_draw_caution_online");
			}
		}
