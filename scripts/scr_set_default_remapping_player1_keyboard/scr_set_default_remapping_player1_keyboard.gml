function scr_set_default_remapping_player1_keyboard(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config == true)
	{
		...
		ini_write_real("config", "player1_key_double_jump", global.player_[inp.key][1][1][action.double_jump]);
		ini_write_real("config", "player1_key2_double_jump", global.player_[inp.key][1][2][action.double_jump]);
