function scr_scale_background()
{
	...
	layer_background_xscale(layer_background_get_id(layer_get_id("Background")), custom_background1_x_scale);
	layer_background_yscale(layer_background_get_id(layer_get_id("Background")), custom_background1_y_scale);
