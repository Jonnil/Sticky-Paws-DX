...
function scr_draw_text_outlined(x_position = x, y_position = y, string_text = "", text_size = global.default_text_size, outline_color = c_black, text_color = c_white, img_alpha = 1, line_sep = 0, max_width = -1)
{
	var use_wrap = (max_width > 0);
	...
	if (use_wrap)
	{
		draw_text_ext_transformed_color(x_position, y_position, string_text, line_sep, max_width, text_size, text_size, 0,
