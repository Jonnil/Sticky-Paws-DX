function scr_load_title_logo_initializing()
{
	...
	first_title_logo = string(file_find_first(working_directory + "custom_title_logo/*", fa_directory))
	if (file_exists(working_directory + "custom_title_logo/" + first_title_logo))
	{
