function scr_menu_navigation_initialization(key_direction_hold_press_release = 0, only_player1_can_navigate = false)
{
	...
	key_up = scr_key_initialize(key_up, key_direction_hold_press_release, which_player, action.up);
	key_left = scr_key_initialize(key_left, key_direction_hold_press_release, which_player, action.left);
	key_right = scr_key_initialize(key_right, key_direction_hold_press_release, which_player, action.right);
	key_down = scr_key_initialize(key_down, key_direction_hold_press_release, which_player, action.down);
