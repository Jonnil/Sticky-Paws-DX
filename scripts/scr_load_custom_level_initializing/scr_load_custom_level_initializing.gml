...
function scr_load_custom_level_initializing()
{
	...
	first_level = string(file_find_first(working_directory+"/Custom Levels/*", fa_directory))
	if (directory_exists(working_directory+"/Custom Levels/"+first_level))
	{
		if (file_exists(working_directory+"/Custom Levels/"+first_level+"/Automatic_Thumbnail.png"))
		{
			ds_list_add(global.thumbnail_sprite, sprite_add(working_directory+"/Custom Levels/"+first_level+"/Automatic_Thumbnail.png", 0, false, true, 0, 0));
		}
		else
		{
