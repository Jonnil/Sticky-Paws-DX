function scr_load_custom_level_initializing()
{
	...
	ds_list_clear(global.thumbnail_sprite); show_debug_message("[scr_load_custom_level_initializing] ds_list_clear(global.thumbnail sprite) Need to clear thumbnails so we can load custom levels all over again");
	...
	if (file_exists(game_save_id + "custom_levels/" + first_level + "/data/level_information.ini"))
	{
		...
		/* PNG Custom Thumbnail */if (file_exists(game_save_id + "custom_levels/" + first_level + "/thumbnail.png"))
		{
