function scr_load_custom_level_initializing()
{
	...
	show_debug_message("[scr_load_custom_level_initializing] 'ds list clear(global thumbnail sprite)' Need to clear thumbnails so we can load custom levels all over again");
