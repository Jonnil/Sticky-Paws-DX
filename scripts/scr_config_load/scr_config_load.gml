function scr_config_load()
{
	if (file_exists(working_directory + "config.ini")) /* Check if config.ini exists before loading any settings */
	{
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_show_controls")){global.player1_show_controls = ini_read_real("player1_profile" + string(global.player1_profile), "player1_show_controls", 0);}//Load Player 1 Keyboard Remapping End
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_show_controls")){global.player2_show_controls = ini_read_real("player2_profile" + string(global.player2_profile), "player2_show_controls", 0);}//Load Player 2 Keyboard Remapping End
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_show_controls")){global.player3_show_controls = ini_read_real("player3_profile" + string(global.player3_profile), "player3_show_controls", 0);}//Load Player 3 Keyboard Remapping End
