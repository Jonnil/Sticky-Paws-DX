function scr_config_load()
{
	if (file_exists(working_directory + "save_file/config.ini")) /* Check if config.ini exists before loading any settings */
	{
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_key_run")){global.player_[inp.key][1][1][action.run] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_key_run", 0);}
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_key_run_toggle")){global.player_[inp.key][1][1][action.run_toggle] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_key_run_toggle", 0);}
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_key2_run")){global.player_[inp.key][1][2][action.run] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_key2_run", 0);}
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_key2_run_toggle")){global.player_[inp.key][1][2][action.run_toggle] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_key2_run_toggle", 0);}
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_down_is_also_crouch")){global.player1_down_is_also_crouch = ini_read_real("player1_profile" + string(global.player1_profile), "player1_down_is_also_crouch", 0);}
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_run_toggle")){global.player1_run_toggle = ini_read_real("player1_profile" + string(global.player1_profile), "player1_run_toggle", 0);}
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_key_run")){global.player_[inp.key][2][1][action.run] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_key_run", 0);}
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_key_run_toggle")){global.player_[inp.key][2][1][action.run_toggle] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_key_run_toggle", 0);}
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_key2_run")){global.player_[inp.key][2][2][action.run] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_key2_run", 0);}
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_key2_run_toggle")){global.player_[inp.key][2][2][action.run_toggle] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_key2_run_toggle", 0);}
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player1_down_is_also_crouch")){global.player2_down_is_also_crouch = ini_read_real("player2_profile" + string(global.player2_profile), "player2_down_is_also_crouch", 0);}
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_run_toggle")){global.player2_run_toggle = ini_read_real("player2_profile" + string(global.player2_profile), "player2_run_toggle", 0);}
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_key_run")){global.player_[inp.key][3][1][action.run] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_key_run", 0);}
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_key_run_toggle")){global.player_[inp.key][3][1][action.run_toggle] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_key_run_toggle", 0);}
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_key2_run")){global.player_[inp.key][3][2][action.run] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_key2_run", 0);}
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_key2_run_toggle")){global.player_[inp.key][3][2][action.run_toggle] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_key2_run_toggle", 0);}
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_down_is_also_crouch")){global.player3_down_is_also_crouch = ini_read_real("player3_profile" + string(global.player1_profile), "player3_down_is_also_crouch", 0);}
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_run_toggle")){global.player3_run_toggle = ini_read_real("player3_profile" + string(global.player3_profile), "player3_run_toggle", 0);}
		...
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_key_run")){global.player_[inp.key][4][1][action.run] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_key_run", 0);}
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_key_run_toggle")){global.player_[inp.key][4][1][action.run_toggle] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_key_run_toggle", 0);}
		...
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_key2_run")){global.player_[inp.key][4][2][action.run] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_key2_run", 0);}
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_key2_run_toggle")){global.player_[inp.key][4][2][action.run_toggle] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_key2_run_toggle", 0);}
		...
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_down_is_also_crouch")){global.player4_down_is_also_crouch = ini_read_real("player4_profile" + string(global.player4_profile), "player4_down_is_also_crouch", 0);}
		...
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_run_toggle")){global.player4_run_toggle = ini_read_real("player4_profile" + string(global.player4_profile), "player4_run_toggle", 0);}
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_gamepad_button_run")){global.player_[inp.gp][1][1][action.run] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button_run", 0);}
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_gamepad_button_run_toggle")){global.player_[inp.gp][1][1][action.run_toggle] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button_run_toggle", 0);}
		...
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_gamepad_button2_run")){global.player_[inp.gp][1][2][action.run] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button2_run", 0);}
		if (ini_key_exists("player1_profile" + string(global.player1_profile), "player1_gamepad_button2_run_toggle")){global.player_[inp.gp][1][2][action.run_toggle] = ini_read_real("player1_profile" + string(global.player1_profile), "player1_gamepad_button2_run_toggle", 0);}
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_gamepad_button_run")){global.player_[inp.gp][2][1][action.run] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button_run", 0);}
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_gamepad_button_run_toggle")){global.player_[inp.gp][2][1][action.run_toggle] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button_run_toggle", 0);}
		...
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_gamepad_button2_run")){global.player_[inp.gp][2][2][action.run] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button2_run", 0);}
		if (ini_key_exists("player2_profile" + string(global.player2_profile), "player2_gamepad_button2_run_toggle")){global.player_[inp.gp][2][2][action.run_toggle] = ini_read_real("player2_profile" + string(global.player2_profile), "player2_gamepad_button2_run_toggle", 0);}
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_gamepad_button_run")){global.player_[inp.gp][3][1][action.run] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button_run", 0);}
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_gamepad_button_run_toggle")){global.player_[inp.gp][3][1][action.run_toggle] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button_run_toggle", 0);}
		...
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_gamepad_button2_run")){global.player_[inp.gp][3][2][action.run] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button2_run", 0);}
		if (ini_key_exists("player3_profile" + string(global.player3_profile), "player3_gamepad_button2_run_toggle")){global.player_[inp.gp][3][2][action.run_toggle] = ini_read_real("player3_profile" + string(global.player3_profile), "player3_gamepad_button2_run_toggle", 0);}
		...
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_gamepad_button_run")){global.player_[inp.gp][4][1][action.run] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button_run", 0);}
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_gamepad_button_run_toggle")){global.player_[inp.gp][4][1][action.run_toggle] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button_run_toggle", 0);}
		...
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_gamepad_button2_run")){global.player_[inp.gp][4][2][action.run] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button2_run", 0);}
		if (ini_key_exists("player4_profile" + string(global.player4_profile), "player4_gamepad_button2_run_toggle")){global.player_[inp.gp][4][2][action.run_toggle] = ini_read_real("player4_profile" + string(global.player4_profile), "player4_gamepad_button2_run_toggle", 0);}
