function scr_config_load()
{
	if (file_exists(working_directory + "config.ini")) /* Check if config.ini exists before loading any settings */
	{
		...
		if (ini_key_exists("config", "player1_key_sprint_toggle")){global.player_[inp.key][1][1][action.sprint_toggle] = ini_read_real("config", "player1_key_sprint_toggle", 0);}
		if (ini_key_exists("config", "player1_key_left")){global.player_[inp.key][1][1][action.left] = ini_read_real("config", "player1_key_left", 0);}
		if (ini_key_exists("config", "player1_key_right")){global.player_[inp.key][1][1][action.right] = ini_read_real("config", "player1_key_right", 0);}
		if (ini_key_exists("config", "player1_key_down")){global.player_[inp.key][1][1][action.down] = ini_read_real("config", "player1_key_down", 0);}
		if (ini_key_exists("config", "player1_key_up")){global.player_[inp.key][1][1][action.up] = ini_read_real("config", "player1_key_up", 0);}
		if (ini_key_exists("config", "player1_key_tongue")){global.player_[inp.key][1][1][action.tongue] = ini_read_real("config", "player1_key_tongue", 0);}
		if (ini_key_exists("config", "player1_key_zoom_in")){global.player_[inp.key][1][1][action.zoom_in] = ini_read_real("config", "player1_key_zoom_in", 0);}
		if (ini_key_exists("config", "player1_key_zoom_out")){global.player_[inp.key][1][1][action.zoom_out] = ini_read_real("config", "player1_key_zoom_out", 0);}
		if (ini_key_exists("config", "player1_key_accept")){global.player_[inp.key][1][1][action.accept] = ini_read_real("config", "player1_key_accept", 0);}
		if (ini_key_exists("config", "player1_key_back")){global.player_[inp.key][1][1][action.back] = ini_read_real("config", "player1_key_back", 0);}
		...
		if (ini_key_exists("config", "player1_key2_sprint_toggle")){global.player_[inp.key][1][2][action.sprint_toggle] = ini_read_real("config", "player1_key2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player1_key2_left")){global.player_[inp.key][1][2][action.left] = ini_read_real("config", "player1_key2_left", 0);}
		if (ini_key_exists("config", "player1_key2_right")){global.player_[inp.key][1][2][action.right] = ini_read_real("config", "player1_key2_right", 0);}
		if (ini_key_exists("config", "player1_key2_down")){global.player_[inp.key][1][2][action.down] = ini_read_real("config", "player1_key2_down", 0);}
		if (ini_key_exists("config", "player1_key2_up")){global.player_[inp.key][1][2][action.up] = ini_read_real("config", "player1_key2_up", 0);}
		if (ini_key_exists("config", "player1_key2_tongue")){global.player_[inp.key][1][2][action.tongue] = ini_read_real("config", "player1_key2_tongue", 0);}
		if (ini_key_exists("config", "player1_key2_zoom_in")){global.player_[inp.key][1][2][action.zoom_in] = ini_read_real("config", "player1_key2_zoom_in", 0);}
		if (ini_key_exists("config", "player1_key2_zoom_out")){global.player_[inp.key][1][2][action.zoom_out] = ini_read_real("config", "player1_key2_zoom_out", 0);}
		if (ini_key_exists("config", "player1_key2_accept")){global.player_[inp.key][1][2][action.accept] = ini_read_real("config", "player1_key2_accept", 0);}
		if (ini_key_exists("config", "player1_key2_back")){global.player_[inp.key][1][2][action.back] = ini_read_real("config", "player1_key2_back", 0);}
		...
		if (ini_key_exists("config", "player2_key_sprint_toggle")){global.player_[inp.key][2][1][action.sprint_toggle] = ini_read_real("config", "player2_key_sprint_toggle", 0);}
		if (ini_key_exists("config", "player2_key_left")){global.player_[inp.key][2][1][action.left] = ini_read_real("config", "player2_key_left", 0);}
		if (ini_key_exists("config", "player2_key_right")){global.player_[inp.key][2][1][action.right] = ini_read_real("config", "player2_key_right", 0);}
		if (ini_key_exists("config", "player2_key_down")){global.player_[inp.key][2][1][action.down] = ini_read_real("config", "player2_key_down", 0);}
		if (ini_key_exists("config", "player2_key_up")){global.player_[inp.key][2][1][action.up] = ini_read_real("config", "player2_key_up", 0);}
		if (ini_key_exists("config", "player2_key_tongue")){global.player_[inp.key][2][1][action.tongue] = ini_read_real("config", "player2_key_tongue", 0);}
		if (ini_key_exists("config", "player2_key_zoom_in")){global.player_[inp.key][2][1][action.zoom_in] = ini_read_real("config", "player2_key_zoom_in", 0);}
		if (ini_key_exists("config", "player2_key_zoom_out")){global.player_[inp.key][2][1][action.zoom_out] = ini_read_real("config", "player2_key_zoom_out", 0);}
		if (ini_key_exists("config", "player2_key_accept")){global.player_[inp.key][2][1][action.accept] = ini_read_real("config", "player2_key_accept", 0);}
		if (ini_key_exists("config", "player2_key_back")){global.player_[inp.key][2][1][action.back] = ini_read_real("config", "player2_key_back", 0);}
		...
		if (ini_key_exists("config", "player2_key2_sprint_toggle")){global.player_[inp.key][2][2][action.sprint_toggle] = ini_read_real("config", "player2_key2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player2_key2_left")){global.player_[inp.key][2][2][action.left] = ini_read_real("config", "player2_key2_left", 0);}
		if (ini_key_exists("config", "player2_key2_right")){global.player_[inp.key][2][2][action.right] = ini_read_real("config", "player2_key2_right", 0);}
		if (ini_key_exists("config", "player2_key2_down")){global.player_[inp.key][2][2][action.down] = ini_read_real("config", "player2_key2_down", 0);}
		if (ini_key_exists("config", "player2_key2_up")){global.player_[inp.key][2][2][action.up] = ini_read_real("config", "player2_key2_up", 0);}
		if (ini_key_exists("config", "player2_key2_tongue")){global.player_[inp.key][2][2][action.tongue] = ini_read_real("config", "player2_key2_tongue", 0);}
		if (ini_key_exists("config", "player2_key2_zoom_in")){global.player_[inp.key][2][2][action.zoom_in] = ini_read_real("config", "player2_key2_zoom_in", 0);}
		if (ini_key_exists("config", "player2_key2_zoom_out")){global.player_[inp.key][2][2][action.zoom_out] = ini_read_real("config", "player2_key2_zoom_out", 0);}
		if (ini_key_exists("config", "player2_key2_accept")){global.player_[inp.key][2][2][action.accept] = ini_read_real("config", "player2_key2_accept", 0);}
		if (ini_key_exists("config", "player2_key2_back")){global.player_[inp.key][2][2][action.back] = ini_read_real("config", "player2_key2_back", 0);}
		...
		if (ini_key_exists("config", "player3_key_sprint_toggle")){global.player_[inp.key][3][1][action.sprint_toggle] = ini_read_real("config", "player3_key_sprint_toggle", 0);}
		if (ini_key_exists("config", "player3_key_left")){global.player_[inp.key][3][1][action.left] = ini_read_real("config", "player3_key_left", 0);}
		if (ini_key_exists("config", "player3_key_right")){global.player_[inp.key][3][1][action.right] = ini_read_real("config", "player3_key_right", 0);}
		if (ini_key_exists("config", "player3_key_down")){global.player_[inp.key][3][1][action.down] = ini_read_real("config", "player3_key_down", 0);}
		if (ini_key_exists("config", "player3_key_up")){global.player_[inp.key][3][1][action.up] = ini_read_real("config", "player3_key_up", 0);}
		if (ini_key_exists("config", "player3_key_tongue")){global.player_[inp.key][3][1][action.tongue] = ini_read_real("config", "player3_key_tongue", 0);}
		if (ini_key_exists("config", "player3_key_zoom_in")){global.player_[inp.key][3][1][action.zoom_in] = ini_read_real("config", "player3_key_zoom_in", 0);}
		if (ini_key_exists("config", "player3_key_zoom_out")){global.player_[inp.key][3][1][action.zoom_out] = ini_read_real("config", "player3_key_zoom_out", 0);}
		if (ini_key_exists("config", "player3_key_accept")){global.player_[inp.key][3][1][action.accept] = ini_read_real("config", "player3_key_accept", 0);}
		if (ini_key_exists("config", "player3_key_back")){global.player_[inp.key][3][1][action.back] = ini_read_real("config", "player3_key_back", 0);}
		...
		if (ini_key_exists("config", "player3_key2_sprint_toggle")){global.player_[inp.key][3][2][action.sprint_toggle] = ini_read_real("config", "player3_key2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player3_key2_left")){global.player_[inp.key][3][2][action.left] = ini_read_real("config", "player3_key2_left", 0);}
		if (ini_key_exists("config", "player3_key2_right")){global.player_[inp.key][3][2][action.right] = ini_read_real("config", "player3_key2_right", 0);}
		if (ini_key_exists("config", "player3_key2_down")){global.player_[inp.key][3][2][action.down] = ini_read_real("config", "player3_key2_down", 0);}
		if (ini_key_exists("config", "player3_key2_up")){global.player_[inp.key][3][2][action.up] = ini_read_real("config", "player3_key2_up", 0);}
		if (ini_key_exists("config", "player3_key2_tongue")){global.player_[inp.key][3][2][action.tongue] = ini_read_real("config", "player3_key2_tongue", 0);}
		if (ini_key_exists("config", "player3_key2_zoom_in")){global.player_[inp.key][3][2][action.zoom_in] = ini_read_real("config", "player3_key2_zoom_in", 0);}
		if (ini_key_exists("config", "player3_key2_zoom_out")){global.player_[inp.key][3][2][action.zoom_out] = ini_read_real("config", "player3_key2_zoom_out", 0);}
		if (ini_key_exists("config", "player3_key2_accept")){global.player_[inp.key][3][2][action.accept] = ini_read_real("config", "player3_key2_accept", 0);}
		if (ini_key_exists("config", "player3_key2_back")){global.player_[inp.key][3][2][action.back] = ini_read_real("config", "player3_key2_back", 0);}
		...
		if (ini_key_exists("config", "player4_key_sprint_toggle")){global.player_[inp.key][4][1][action.sprint_toggle] = ini_read_real("config", "player4_key_sprint_toggle", 0);}
		if (ini_key_exists("config", "player4_key_left")){global.player_[inp.key][4][1][action.left] = ini_read_real("config", "player4_key_left", 0);}
		if (ini_key_exists("config", "player4_key_right")){global.player_[inp.key][4][1][action.right] = ini_read_real("config", "player4_key_right", 0);}
		if (ini_key_exists("config", "player4_key_down")){global.player_[inp.key][4][1][action.down] = ini_read_real("config", "player4_key_down", 0);}
		if (ini_key_exists("config", "player4_key_up")){global.player_[inp.key][4][1][action.up] = ini_read_real("config", "player4_key_up", 0);}
		if (ini_key_exists("config", "player4_key_tongue")){global.player_[inp.key][4][1][action.tongue] = ini_read_real("config", "player4_key_tongue", 0);}
		if (ini_key_exists("config", "player4_key_zoom_in")){global.player_[inp.key][4][1][action.zoom_in] = ini_read_real("config", "player4_key_zoom_in", 0);}
		if (ini_key_exists("config", "player4_key_zoom_out")){global.player_[inp.key][4][1][action.zoom_out] = ini_read_real("config", "player4_key_zoom_out", 0);}
		if (ini_key_exists("config", "player4_key_accept")){global.player_[inp.key][4][1][action.accept] = ini_read_real("config", "player4_key_accept", 0);}
		if (ini_key_exists("config", "player4_key_back")){global.player_[inp.key][4][1][action.back] = ini_read_real("config", "player4_key_back", 0);}
		...
		if (ini_key_exists("config", "player4_key2_sprint_toggle")){global.player_[inp.key][4][2][action.sprint_toggle] = ini_read_real("config", "player4_key2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player4_key2_left")){global.player_[inp.key][4][2][action.left] = ini_read_real("config", "player4_key2_left", 0);}
		if (ini_key_exists("config", "player4_key2_right")){global.player_[inp.key][4][2][action.right] = ini_read_real("config", "player4_key2_right", 0);}
		if (ini_key_exists("config", "player4_key2_down")){global.player_[inp.key][4][2][action.down] = ini_read_real("config", "player4_key2_down", 0);}
		if (ini_key_exists("config", "player4_key2_up")){global.player_[inp.key][4][2][action.up] = ini_read_real("config", "player4_key2_up", 0);}
		if (ini_key_exists("config", "player4_key2_tongue")){global.player_[inp.key][4][2][action.tongue] = ini_read_real("config", "player4_key2_tongue", 0);}
		if (ini_key_exists("config", "player4_key2_zoom_in")){global.player_[inp.key][4][2][action.zoom_in] = ini_read_real("config", "player4_key2_zoom_in", 0);}
		if (ini_key_exists("config", "player4_key2_zoom_out")){global.player_[inp.key][4][2][action.zoom_out] = ini_read_real("config", "player4_key2_zoom_out", 0);}
		if (ini_key_exists("config", "player4_key2_accept")){global.player_[inp.key][4][2][action.accept] = ini_read_real("config", "player4_key2_accept", 0);}
		if (ini_key_exists("config", "player4_key2_back")){global.player_[inp.key][4][2][action.back] = ini_read_real("config", "player4_key2_back", 0);}
		...
		if (ini_key_exists("config", "player1_gamepad_button_sprint_toggle")){global.player_[inp.gp][1][1][action.sprint_toggle] = ini_read_real("config", "player1_gamepad_button_sprint_toggle", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_left")){global.player_[inp.gp][1][1][action.left] = ini_read_real("config", "player1_gamepad_button_left", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_right")){global.player_[inp.gp][1][1][action.right] = ini_read_real("config", "player1_gamepad_button_right", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_down")){global.player_[inp.gp][1][1][action.down] = ini_read_real("config", "player1_gamepad_button_down", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_up")){global.player_[inp.gp][1][1][action.up] = ini_read_real("config", "player1_gamepad_button_up", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_tongue")){global.player_[inp.gp][1][1][action.tongue] = ini_read_real("config", "player1_gamepad_button_tongue", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_zoom_in")){global.player_[inp.gp][1][1][action.zoom_in] = ini_read_real("config", "player1_gamepad_button_zoom_in", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_zoom_out")){global.player_[inp.gp][1][1][action.zoom_out] = ini_read_real("config", "player1_gamepad_button_zoom_out", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_accept")){global.player_[inp.gp][1][1][action.accept] = ini_read_real("config", "player1_gamepad_button_accept", 0);}
		if (ini_key_exists("config", "player1_gamepad_button_back")){global.player_[inp.gp][1][1][action.back] = ini_read_real("config", "player1_gamepad_button_back", 0);}
		...
		if (ini_key_exists("config", "player1_gamepad_button2_sprint_toggle")){global.player_[inp.gp][1][2][action.sprint_toggle] = ini_read_real("config", "player1_gamepad_button2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_left")){global.player_[inp.gp][1][2][action.left] = ini_read_real("config", "player1_gamepad_button2_left", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_right")){global.player_[inp.gp][1][2][action.right] = ini_read_real("config", "player1_gamepad_button2_right", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_down")){global.player_[inp.gp][1][2][action.down] = ini_read_real("config", "player1_gamepad_button2_down", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_up")){global.player_[inp.gp][1][2][action.up] = ini_read_real("config", "player1_gamepad_button2_up", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_tongue")){global.player_[inp.gp][1][2][action.tongue] = ini_read_real("config", "player1_gamepad_button2_tongue", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_zoom_in")){global.player_[inp.gp][1][2][action.zoom_in] = ini_read_real("config", "player1_gamepad_button2_zoom_in", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_zoom_out")){global.player_[inp.gp][1][2][action.zoom_out] = ini_read_real("config", "player1_gamepad_button2_zoom_out", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_accept")){global.player_[inp.gp][1][2][action.accept] = ini_read_real("config", "player1_gamepad_button2_accept", 0);}
		if (ini_key_exists("config", "player1_gamepad_button2_back")){global.player_[inp.gp][1][2][action.back] = ini_read_real("config", "player1_gamepad_button2_back", 0);}
		...
		if (ini_key_exists("config", "player2_gamepad_button_sprint_toggle")){global.player_[inp.gp][2][1][action.sprint_toggle] = ini_read_real("config", "player2_gamepad_button_sprint_toggle", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_left")){global.player_[inp.gp][2][1][action.left] = ini_read_real("config", "player2_gamepad_button_left", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_right")){global.player_[inp.gp][2][1][action.right] = ini_read_real("config", "player2_gamepad_button_right", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_down")){global.player_[inp.gp][2][1][action.down] = ini_read_real("config", "player2_gamepad_button_down", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_up")){global.player_[inp.gp][2][1][action.up] = ini_read_real("config", "player2_gamepad_button_up", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_tongue")){global.player_[inp.gp][2][1][action.tongue] = ini_read_real("config", "player2_gamepad_button_tongue", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_zoom_in")){global.player_[inp.gp][2][1][action.zoom_in] = ini_read_real("config", "player2_gamepad_button_zoom_in", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_zoom_out")){global.player_[inp.gp][2][1][action.zoom_out] = ini_read_real("config", "player2_gamepad_button_zoom_out", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_accept")){global.player_[inp.gp][2][1][action.accept] = ini_read_real("config", "player2_gamepad_button_accept", 0);}
		if (ini_key_exists("config", "player2_gamepad_button_back")){global.player_[inp.gp][2][1][action.back] = ini_read_real("config", "player2_gamepad_button_back", 0);}
		...
		if (ini_key_exists("config", "player2_gamepad_button2_sprint_toggle")){global.player_[inp.gp][2][2][action.sprint_toggle] = ini_read_real("config", "player2_gamepad_button2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_left")){global.player_[inp.gp][2][2][action.left] = ini_read_real("config", "player2_gamepad_button2_left", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_right")){global.player_[inp.gp][2][2][action.right] = ini_read_real("config", "player2_gamepad_button2_right", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_down")){global.player_[inp.gp][2][2][action.down] = ini_read_real("config", "player2_gamepad_button2_down", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_up")){global.player_[inp.gp][2][2][action.up] = ini_read_real("config", "player2_gamepad_button2_up", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_tongue")){global.player_[inp.gp][2][2][action.tongue] = ini_read_real("config", "player2_gamepad_button2_tongue", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_zoom_in")){global.player_[inp.gp][2][2][action.zoom_in] = ini_read_real("config", "player2_gamepad_button2_zoom_in", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_zoom_out")){global.player_[inp.gp][2][2][action.zoom_out] = ini_read_real("config", "player2_gamepad_button2_zoom_out", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_accept")){global.player_[inp.gp][2][2][action.accept] = ini_read_real("config", "player2_gamepad_button2_accept", 0);}
		if (ini_key_exists("config", "player2_gamepad_button2_back")){global.player_[inp.gp][2][2][action.back] = ini_read_real("config", "player2_gamepad_button2_back", 0);}
		...
		if (ini_key_exists("config", "player3_gamepad_button_sprint_toggle")){global.player_[inp.gp][3][1][action.sprint_toggle] = ini_read_real("config", "player3_gamepad_button_sprint_toggle", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_left")){global.player_[inp.gp][3][1][action.left] = ini_read_real("config", "player3_gamepad_button_left", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_right")){global.player_[inp.gp][3][1][action.right] = ini_read_real("config", "player3_gamepad_button_right", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_down")){global.player_[inp.gp][3][1][action.down] = ini_read_real("config", "player3_gamepad_button_down", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_up")){global.player_[inp.gp][3][1][action.up] = ini_read_real("config", "player3_gamepad_button_up", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_tongue")){global.player_[inp.gp][3][1][action.tongue] = ini_read_real("config", "player3_gamepad_button_tongue", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_zoom_in")){global.player_[inp.gp][3][1][action.zoom_in] = ini_read_real("config", "player3_gamepad_button_zoom_in", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_zoom_out")){global.player_[inp.gp][3][1][action.zoom_out] = ini_read_real("config", "player3_gamepad_button_zoom_out", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_accept")){global.player_[inp.gp][3][1][action.accept] = ini_read_real("config", "player3_gamepad_button_accept", 0);}
		if (ini_key_exists("config", "player3_gamepad_button_back")){global.player_[inp.gp][3][1][action.back] = ini_read_real("config", "player3_gamepad_button_back", 0);}
		...
		if (ini_key_exists("config", "player3_gamepad_button2_sprint_toggle")){global.player_[inp.gp][3][2][action.sprint_toggle] = ini_read_real("config", "player3_gamepad_button2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_left")){global.player_[inp.gp][3][2][action.left] = ini_read_real("config", "player3_gamepad_button2_left", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_right")){global.player_[inp.gp][3][2][action.right] = ini_read_real("config", "player3_gamepad_button2_right", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_down")){global.player_[inp.gp][3][2][action.down] = ini_read_real("config", "player3_gamepad_button2_down", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_up")){global.player_[inp.gp][3][2][action.up] = ini_read_real("config", "player3_gamepad_button2_up", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_tongue")){global.player_[inp.gp][3][2][action.tongue] = ini_read_real("config", "player3_gamepad_button2_tongue", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_zoom_in")){global.player_[inp.gp][3][2][action.zoom_in] = ini_read_real("config", "player3_gamepad_button2_zoom_in", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_zoom_out")){global.player_[inp.gp][3][2][action.zoom_out] = ini_read_real("config", "player3_gamepad_button2_zoom_out", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_accept")){global.player_[inp.gp][3][2][action.accept] = ini_read_real("config", "player3_gamepad_button2_accept", 0);}
		if (ini_key_exists("config", "player3_gamepad_button2_back")){global.player_[inp.gp][3][2][action.back] = ini_read_real("config", "player3_gamepad_button2_back", 0);}
		...
		if (ini_key_exists("config", "player4_gamepad_button_sprint_toggle")){global.player_[inp.gp][4][1][action.sprint_toggle] = ini_read_real("config", "player4_gamepad_button_sprint_toggle", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_left")){global.player_[inp.gp][4][1][action.left] = ini_read_real("config", "player4_gamepad_button_left", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_right")){global.player_[inp.gp][4][1][action.right] = ini_read_real("config", "player4_gamepad_button_right", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_down")){global.player_[inp.gp][4][1][action.down] = ini_read_real("config", "player4_gamepad_button_down", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_up")){global.player_[inp.gp][4][1][action.up] = ini_read_real("config", "player4_gamepad_button_up", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_tongue")){global.player_[inp.gp][4][1][action.tongue] = ini_read_real("config", "player4_gamepad_button_tongue", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_zoom_in")){global.player_[inp.gp][4][1][action.zoom_in] = ini_read_real("config", "player4_gamepad_button_zoom_in", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_zoom_out")){global.player_[inp.gp][4][1][action.zoom_out] = ini_read_real("config", "player4_gamepad_button_zoom_out", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_accept")){global.player_[inp.gp][4][1][action.accept] = ini_read_real("config", "player4_gamepad_button_accept", 0);}
		if (ini_key_exists("config", "player4_gamepad_button_back")){global.player_[inp.gp][4][1][action.back] = ini_read_real("config", "player4_gamepad_button_back", 0);}
		...
		if (ini_key_exists("config", "player4_gamepad_button2_sprint_toggle")){global.player_[inp.gp][4][2][action.sprint_toggle] = ini_read_real("config", "player4_gamepad_button2_sprint_toggle", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_left")){global.player_[inp.gp][4][2][action.left] = ini_read_real("config", "player4_gamepad_button2_left", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_right")){global.player_[inp.gp][4][2][action.right] = ini_read_real("config", "player4_gamepad_button2_right", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_down")){global.player_[inp.gp][4][2][action.down] = ini_read_real("config", "player4_gamepad_button2_down", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_up")){global.player_[inp.gp][4][2][action.up] = ini_read_real("config", "player4_gamepad_button2_up", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_tongue")){global.player_[inp.gp][4][2][action.tongue] = ini_read_real("config", "player4_gamepad_button2_tongue", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_zoom_in")){global.player_[inp.gp][4][2][action.zoom_in] = ini_read_real("config", "player4_gamepad_button2_zoom_in", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_zoom_out")){global.player_[inp.gp][4][2][action.zoom_out] = ini_read_real("config", "player4_gamepad_button2_zoom_out", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_accept")){global.player_[inp.gp][4][2][action.accept] = ini_read_real("config", "player4_gamepad_button2_accept", 0);}
		if (ini_key_exists("config", "player4_gamepad_button2_back")){global.player_[inp.gp][4][2][action.back] = ini_read_real("config", "player4_gamepad_button2_back", 0);}
