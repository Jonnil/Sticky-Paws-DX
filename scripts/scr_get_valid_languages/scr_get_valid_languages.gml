function scr_get_valid_languages()
{
	...
	/* Start at the column defined by global.language_column_start */
	for(var i = global.language_column_start; i < ds_grid_width(global.language_local_data); i ++;)
	{
		...
		{
			/* In Switch Guidelines, every language needs to be 100% translated, can't include unfinished translations */
