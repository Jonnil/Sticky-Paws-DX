function scr_set_default_remapping_player1_gamepad(save_default_controls_to_config = false)
{
	...
	if (save_default_controls_to_config == true)
	{
		...
		ini_write_real("config", "player1_gamepad_button_double_jump", global.player_[inp.gp][1][1][action.double_jump]);
		ini_write_real("config", "player1_gamepad_button2_double_jump", global.player_[inp.gp][1][2][action.double_jump]);
