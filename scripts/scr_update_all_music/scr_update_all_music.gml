function scr_update_all_music()
{
	...
	&& (file_exists(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/music.ogg"))
	&& (global.character_select_in_this_menu == "level_editor")
	{
		global.music = audio_create_stream(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/music.ogg");
	}
	else
	...
	/* OGG small letter File */
	if (global.can_load_custom_level_assets)
	&& (file_exists(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/music_underwater.ogg"))
	&& (global.character_select_in_this_menu == "level_editor")
	{
		global.music_underwater = audio_create_stream(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/music_underwater.ogg");
	}
	else
	...
	/* OGG small letter File */
	if (global.can_load_custom_level_assets)
	&& (file_exists(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/ambience.ogg"))
	&& (global.character_select_in_this_menu == "level_editor")
	{
		global.ambience = audio_create_stream(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/ambience.ogg");
	}
	else
	...
	/* OGG small letter File */
	if (global.can_load_custom_level_assets)
	&& (file_exists(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/ambience_underwater.ogg"))
	&& (global.character_select_in_this_menu == "level_editor")
	{
		global.ambience_underwater = audio_create_stream(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/ambience_underwater.ogg");
	}
	else
	...
	/* OGG small letter File */
	if (global.can_load_custom_level_assets)
	&& (file_exists(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/clear_melody.ogg"))
	&& (global.character_select_in_this_menu == "level_editor")
	{
		global.level_clear_melody = audio_create_stream(global.use_temp_or_working + "custom_levels/" + global.level_name + "/sound/clear_melody.ogg");
	}
	else
