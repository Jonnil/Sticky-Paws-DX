...
if (kind_of_button = 0)
{
	...
	draw_text_outlined(x + sprite_width / 2, y+ sprite_height/ 2,string(menu_text), global.default_text_size, c_white, c_black, 1);
...
if (kind_of_button = 1)
{
	...
	draw_set_valign(fa_center);
	draw_text_outlined(x + 42, y + 16,string(menu_text), global.default_text_size, c_white, c_black, 1);
