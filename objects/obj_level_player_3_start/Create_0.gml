...
and (file_exists(working_directory + "/custom_levels/" + string(ds_list_find_value(global.all_loaded_custom_levels, global.select_level_index)) + "/data/level_information.ini"))
{
	...
	if (ini_key_exists("info", "level_player_3_start_x"))
	{
		x = ini_read_real("info", "level_player_3_start_x", 0);
	}
	if (ini_key_exists("info", "level_player_3_start_y"))
	{
		y = ini_read_real("info", "level_player_3_start_y", 0);
	}
	ini_close();
}