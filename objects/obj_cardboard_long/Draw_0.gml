...
if (brick_particle = false)
{
	...
	and (instance_exists(obj_player))
	{
		...
		and (x + 26 < camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current]) + outside_view_offset)
		and (x - 106 > camera_get_view_x(view_camera[view_current]) - outside_view_offset)
		and (y + 26 < camera_get_view_y(view_camera[view_current]) + camera_get_view_height(view_camera[view_current]) + outside_view_offset)
		and (y + 26 > camera_get_view_y(view_camera[view_current]) - outside_view_offset)
