...
if (brick_particle = false)
{
	...
	and (instance_exists(obj_player))
	{
		...
		and (bbox_left < camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current]) + outside_view_offset)
		and (bbox_right > camera_get_view_x(view_camera[view_current]) - outside_view_offset)
		...
		and (bbox_top > camera_get_view_y(view_camera[view_current]) - outside_view_offset)
