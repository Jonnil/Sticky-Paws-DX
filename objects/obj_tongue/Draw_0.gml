...
if timer>10{if place_meeting(x,y,obj_player)and instance_nearest(x,y,obj_player).ropeswing=false{with(instance_nearest(x,y,obj_player)){can_tongue=true;}instance_destroy();}}
if timer=15{speed=0;}
if timer>25{move_towards_point(instance_nearest(x,y,obj_player).x,instance_nearest(x,y,obj_player).y,32);obj_player.ropeswing=false}
...
if obj_player.ropeswing=false{hspeed+=obj_player.hspeed/8;vspeed+=obj_player.vspeed/8;}
...
{speed=0;timer=15;with(instance_nearest(x,y,obj_player)){ropeswing=true;}}/*ropeswing on things END*/
else
...
//if collision_line(x,y,instance_nearest(x,y,obj_player).x,instance_nearest(x,y,obj_player).y,obj_wall,false,true){move_towards_point(instance_nearest(x,y,obj_player).x,instance_nearest(x,y,obj_player).y,32);with(instance_nearest(x,y,obj_player)){ropeswing=false;}}

if instance_nearest(x,y,obj_player).climb=true or instance_nearest(x,y,obj_player).horizontal_rope_climb=true{move_towards_point(instance_nearest(x,y,obj_player).x,instance_nearest(x,y,obj_player).y,32);obj_player.ropeswing=false;}

draw_line_width_colour(x,y,instance_nearest(x,y,obj_player).x,instance_nearest(x,y,obj_player).y,3,c_red,c_red);
draw_self();}