...
and (!place_meeting(x - 32, y, obj_level_player1_start))
and (!place_meeting(x - 32, y, obj_level_player2_start))
and (!place_meeting(x - 32, y, obj_level_player3_start))
and (!place_meeting(x - 32, y, obj_level_player4_start))
...
and (!place_meeting(x, y - 32, obj_level_player1_start))
and (!place_meeting(x, y - 32, obj_level_player2_start))
and (!place_meeting(x, y - 32, obj_level_player3_start))
and (!place_meeting(x, y - 32, obj_level_player4_start))
