...
draw_rectangle_color(x - room_width, y - room_height, room_width + camera_get_view_width(view_get_camera(view_current)) + 32, room_height + camera_get_view_height(view_get_camera(view_current)) + 32, color, color, color, color, false);
draw_set_alpha(1);
