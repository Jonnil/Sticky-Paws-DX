...
if (hide_menu_for_clean_screenshots == false)
{
	...
	and (show_loading_icon = false)
	{
		...
		if (menu == "continue")
		{
			if (key_a_pressed)
			and (menu_delay == 0)
			or (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2, get_window_width / 2 + 185, get_window_height / 2 + 41))
		...
		if (menu == "options")
		{
			...
			or (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2 + 42, get_window_width / 2 + 185, get_window_height / 2 + 41 + 42))
			and (mouse_check_button_pressed(mb_left))
			and (menu_delay == 0)
			and (global.convention_mode = false)
			{
		...
		if (menu == "restart")
		{
			...
			or (global.pause_room = room_leveleditor)
			and (global.convention_mode = false)
			and (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2 + 42 + 42, get_window_width / 2 + 185, get_window_height / 2 + 41 + 42 + 42))
			and (mouse_check_button_pressed(mb_left))
			and (menu_delay == 0)
			or (global.pause_room = room_leveleditor)
			and (global.convention_mode == true)
			and (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2 + 42, get_window_width / 2 + 185, get_window_height / 2 + 41 + 42))
			and (mouse_check_button_pressed(mb_left))
			and (menu_delay == 0)
			{
		...
		if (menu == "reset_from_checkpoint")
		{
			...
			and (menu_delay == 0)
			or (global.pause_room = room_leveleditor)
			and (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2, get_window_width / 2 + 185, get_window_height / 2 + 41))
			and (mouse_check_button_pressed(mb_left))
			and (menu_delay == 0)
			{
		...
		if (menu == "restart_nevermind")
		{
			if (key_a_pressed)
			and (menu_delay == 0)
			or (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2 + 42 + 42, get_window_width / 2 + 185, get_window_height / 2 + 41 + 42 + 42))
			and (mouse_check_button_pressed(mb_left))
			and (menu_delay == 0)
			{
				menu_delay = 3;
		...
		if (menu == "quit")
		{
			...
			or (global.pause_room = room_leveleditor)
			and (global.convention_mode = false)
			and (point_in_rectangle(mouse_get_x, mouse_get_y, get_window_width / 2 - 185, get_window_height / 2 + 2 + 42 + 42 + 42, get_window_width / 2 + 185, get_window_height / 2 + 41 + 42 + 42 + 42))
			and (mouse_check_button_pressed(mb_left))
			and (menu_delay == 0)
			or (global.pause_room = room_world_map)
			and (global.convention_mode == true)
