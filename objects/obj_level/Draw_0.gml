...
draw_sprite_ext(spr_level_ring, 0, draw_x, draw_y, draw_scale, draw_scale, 0, ring_color, 1);
draw_sprite_ext(spr_level, 0, draw_x, draw_y, draw_scale, draw_scale, 0, level_color, 1);
if (level_perfect) {
...
if (level_number != 0) {
    ...
    scr_draw_text_outlined(draw_x, draw_y, string(level_number), global.default_text_size * 2, c_black, c_white, 1);
}
