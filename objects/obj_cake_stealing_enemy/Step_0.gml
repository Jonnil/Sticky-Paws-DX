var view_left = camera_get_view_x(view_get_camera(view_current)) - 42;
var view_right = (camera_get_view_x(view_get_camera(view_current))) + (camera_get_view_width(view_get_camera(view_current))) + 42;
var view_top = camera_get_view_y(view_get_camera(view_current)) - 42;
var view_bottom = (camera_get_view_y(view_get_camera(view_current))) + (camera_get_view_height(view_get_camera(view_current))) + 42;
