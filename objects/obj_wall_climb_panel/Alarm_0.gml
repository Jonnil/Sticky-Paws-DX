...
if (instance_exists(obj_camera))
{
	...
	&& (obj_camera.player1.allow_wall_climb == false)
	|| (obj_camera.player2 > 0)
	&& (instance_exists(obj_camera.player2))
	&& (obj_camera.player2.allow_wall_climb == false)
	|| (obj_camera.player3 > 0)
	&& (instance_exists(obj_camera.player3))
	&& (obj_camera.player3.allow_wall_climb == false)
	|| (obj_camera.player4 > 0)
	&& (instance_exists(obj_camera.player4))
	&& (obj_camera.player4.allow_wall_climb == false)
