...
/* Let zoom notification timers settle even while their graphics are hidden. */
...
scr_draw_level_hud(!capture_mode_hides_ui);
...
/* Clear-check checkpoint behavior must continue even when Capture Mode hides its label. */
if (doing_clear_check_level || doing_clear_check_character)
{
