...
if (player1 > 0)
{
	...
	&& (player1.frames_until_drowning <= player1.seconds_until_drowning*60-1)
	{
		draw_circular_bar(player1.x + 2, player1.bbox_top - 54, player1.frames_until_drowning, player1.seconds_until_drowning*60, c_black, 20, 0.8, 6); /*Outline*/
		draw_circular_bar(player1.x, player1.bbox_top - 56, player1.frames_until_drowning, player1.seconds_until_drowning*60, MakeColorHSVTransition(player1.frames_until_drowning, player1.seconds_until_drowning*60, 0, 100, 255, 255, 255, 255), 20, 1, 6); /*Drown Bar*/
	}
}
...
if (player2 > 0)
{
	...
	&& (player2.frames_until_drowning <= player2.seconds_until_drowning*60-1)
	{
		draw_circular_bar(player2.x + 2, player2.bbox_top - 54, player2.frames_until_drowning, player2.seconds_until_drowning*60, c_black, 20, 0.8, 6); /*Outline*/
		draw_circular_bar(player2.x, player2.bbox_top - 56, player2.frames_until_drowning, player2.seconds_until_drowning*60, MakeColorHSVTransition(player2.frames_until_drowning, player2.seconds_until_drowning*60, 0, 100, 255, 255, 255, 255), 20, 1, 6); /*Drown Bar*/
	}
}
...
if (player3 > 0)
{
	...
	&& (player3.frames_until_drowning <= player3.seconds_until_drowning*60-1)
	{
		draw_circular_bar(player3.x + 2, player3.bbox_top - 54, player3.frames_until_drowning, player3.seconds_until_drowning*60, c_black, 20, 0.8, 6); /*Outline*/
		draw_circular_bar(player3.x, player3.bbox_top - 56, player3.frames_until_drowning, player3.seconds_until_drowning*60, MakeColorHSVTransition(player3.frames_until_drowning, player3.seconds_until_drowning*60, 0, 100, 255, 255, 255, 255), 20, 1, 6); /*Drown Bar*/
	}
}
...
if (player4 > 0)
{
	...
	&& (player4.frames_until_drowning <= player4.seconds_until_drowning*60-1)
	{
		draw_circular_bar(player4.x + 2, player4.bbox_top - 54, player4.frames_until_drowning, player4.seconds_until_drowning*60, c_black, 20, 0.8, 6); /*Outline*/
		draw_circular_bar(player4.x, player4.bbox_top - 56, player4.frames_until_drowning, player4.seconds_until_drowning*60, MakeColorHSVTransition(player4.frames_until_drowning, player4.seconds_until_drowning*60, 0, 100, 255, 255, 255, 255), 20, 1, 6); /*Drown Bar*/
	}
}
