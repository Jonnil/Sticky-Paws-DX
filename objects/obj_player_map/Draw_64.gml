...
and (global.pause == false)
{
	...
	scr_draw_text_outlined(64, get_window_height - 28, l10n_text("Enter into level"), global.default_text_size, c_black, c_white, 1);
...
if (show_demo_over_message == true)
{
	...
	draw_set_halign(fa_center);
	draw_set_valign(fa_middle);
	scr_draw_text_outlined(get_window_width / 2, get_window_height / 2, l10n_text("The demo is over"), global.default_text_size, c_black, c_white, 1);
	scr_draw_text_outlined(get_window_width / 2, get_window_height / 2 + 32, l10n_text("Buy the full version of") + " " + string(global.game_name), global.default_text_size, c_black, c_white, 1);
	draw_menu_button(get_window_width / 2 - 185, get_window_height / 2 + 64, l10n_text("Purchase now!"), "purchase_now", noone)
	draw_menu_button(get_window_width / 2 - 185, get_window_height / 2 + 106, l10n_text("Continue playing!"), "continue_playing", noone)
}
if (menu == noone)
{
