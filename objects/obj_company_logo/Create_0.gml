...
global.download_failure_reason = ""; /* Human-readable reason for download failure states */
global.expected_download_zip_path = ""; /* Deterministic save target for the active ID download */
global.online_list_loaded = false;
global.force_online_list_refresh = false;
global.allow_runtime_switch_save_resize = false; /* Safety default for release: do not resize save data during interactive menu flows */
...
global.switch_save_preflight_min_free_bytes = 8 * 1024 * 1024; /* Block write-heavy Switch actions when free user save budget falls below this threshold. */
