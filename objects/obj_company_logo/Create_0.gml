...
global.account_name = ""; /* Account name for when you upload levels, you enter an account name in account settings, and the levels uploaded will be credited under this name */
