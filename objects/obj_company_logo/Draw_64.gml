...
{
	draw_sprite_ext(sprite_index, image_index, get_window_width * 0.5, get_window_height * 0.5 - 200, 1, 1, 0, c_white, 1); /* Show the Company Logo above the "Made with GameMaker" logo */
	draw_sprite_ext(spr_made_with_gamemaker, image_index, get_window_width * 0.5, get_window_height * 0.5 + 100, 0.9, 0.9, 0, c_white, made_with_gamemaker_alpha); /* Show that the game was made with GameMaker underneath the Company Logo */
}
else
if (sprite_index >= 0)
{
