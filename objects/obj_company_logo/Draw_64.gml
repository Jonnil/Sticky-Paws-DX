...
if (sprite_index == spr_company_logo)
{
	...
	draw_sprite_ext(spr_made_with_gamemaker, image_index, get_window_width * 0.5, get_window_height * 0.5 + 140, 0.9, 0.9, 0, c_white, made_with_gamemaker_alpha); /* Show that the game was made with GameMaker underneath the Company Logo */
}
else
if (sprite_index >= 0)
{
...
if (show_skip_button)
{
	...
	|| (global.always_show_gamepad_buttons)
	{
		...
		scr_draw_gamepad_buttons(skip_button, display_get_gui_width() * 0.5 + 64, display_get_gui_height() - 17, 0.5, c_white, show_skip_button_alpha);
	}
	else
	{
		draw_set_halign(fa_right);
