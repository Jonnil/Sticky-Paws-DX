...
#region /*Mask Index*/
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png"))
{
	sprite_mask = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png", 0, false, false, mask_xorig, mask_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png"))
{
	sprite_mask = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png", 0, false, false, mask_xorig, mask_yorig);
}
else
...
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask_crouch.png"))
{
	sprite_mask_crouch = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask_crouch.png", 0, false, false, mask_crouch_xorig, mask_crouch_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask_crouch.png"))
{
	sprite_mask_crouch = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask_crouch.png", 0, false, false, mask_crouch_xorig, mask_crouch_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png"))
{
	sprite_mask_crouch = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png", 0, false, false, mask_xorig, mask_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png"))
{
	sprite_mask_crouch = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/mask.png", 0, false, false, mask_xorig, mask_yorig);
}
else
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something_strip" + string(index)+".png"))
	{
		sprite_standing_on_something = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something_strip" + string(index)+".png", index, false, false, sprite_standing_on_something_xorig, sprite_standing_on_something_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something_strip" + string(index)+".png"))
	{
		sprite_standing_on_something = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something_strip" + string(index)+".png", index, false, false, sprite_standing_on_something_xorig, sprite_standing_on_something_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something.png"))
{
	sprite_standing_on_something = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something.png", 1, false, false, sprite_standing_on_something_xorig, sprite_standing_on_something_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something.png"))
{
	sprite_standing_on_something = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/standing_on_something.png", 1, false, false, sprite_standing_on_something_xorig, sprite_standing_on_something_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_strip" + string(index)+".png"))
	{
		sprite_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_strip" + string(index)+".png", index, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup_strip" + string(index)+".png"))
	{
		sprite_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup_strip" + string(index)+".png", index, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_strip" + string(index)+".png"))
	{
		sprite_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_strip" + string(index)+".png", index, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup_strip" + string(index)+".png"))
	{
		sprite_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup_strip" + string(index)+".png", index, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up.png"))
{
	sprite_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up.png", 1, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup.png"))
{
	sprite_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup.png", 1, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up.png"))
{
	sprite_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up.png", 1, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup.png"))
{
	sprite_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/lookup.png", 1, false, false, sprite_look_up_xorig, sprite_look_up_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start_strip" + string(index)+".png"))
	{
		sprite_look_up_start = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start_strip" + string(index)+".png", index, false, false, sprite_look_up_start_xorig, sprite_look_up_start_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start_strip" + string(index)+".png"))
	{
		sprite_look_up_start = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start_strip" + string(index)+".png", index, false, false, sprite_look_up_start_xorig, sprite_look_up_start_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start.png"))
{
	sprite_look_up_start = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start.png", 1, false, false, sprite_look_up_start_xorig, sprite_look_up_start_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start.png"))
{
	sprite_look_up_start = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/look_up_start.png", 1, false, false, sprite_look_up_start_xorig, sprite_look_up_start_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_strip" + string(index)+".png"))
	{
		sprite_crouch = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_strip" + string(index)+".png", index, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_strip" + string(index)+".png"))
	{
		sprite_crouch = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_strip" + string(index)+".png", index, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_strip" + string(index)+".png"))
	{
		sprite_crouch = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_strip" + string(index)+".png", index, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_strip" + string(index)+".png"))
	{
		sprite_crouch = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_strip" + string(index)+".png", index, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch.png"))
{
	sprite_crouch = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch.png", 1, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat.png"))
{
	sprite_crouch = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat.png", 1, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch.png"))
{
	sprite_crouch = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch.png", 1, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat.png"))
{
	sprite_crouch = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat.png", 1, false, false, sprite_crouch_xorig, sprite_crouch_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl_strip" + string(index)+".png"))
	{
		sprite_crouch_crawl = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl_strip" + string(index)+".png", index, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl_strip" + string(index)+".png"))
	{
		sprite_crouch_crawl = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl_strip" + string(index)+".png", index, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl_strip" + string(index)+".png"))
	{
		sprite_crouch_crawl = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl_strip" + string(index)+".png", index, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl_strip" + string(index)+".png"))
	{
		sprite_crouch_crawl = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl_strip" + string(index)+".png", index, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl.png"))
{
	sprite_crouch_crawl = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl.png", 1, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl.png"))
{
	sprite_crouch_crawl = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl.png", 1, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl.png"))
{
	sprite_crouch_crawl = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crawl.png", 1, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl.png"))
{
	sprite_crouch_crawl = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_crawl.png", 1, false, false, sprite_crawl_xorig, sprite_crawl_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump_strip" + string(index)+".png"))
	{
		sprite_crouch_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump_strip" + string(index)+".png", index, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump_strip" + string(index)+".png"))
	{
		sprite_crouch_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump_strip" + string(index)+".png", index, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump_strip" + string(index)+".png"))
	{
		sprite_crouch_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump_strip" + string(index)+".png", index, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump_strip" + string(index)+".png"))
	{
		sprite_crouch_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump_strip" + string(index)+".png", index, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump.png"))
{
	sprite_crouch_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump.png", 1, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump.png"))
{
	sprite_crouch_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump.png", 1, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump.png"))
{
	sprite_crouch_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_jump.png", 1, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump.png"))
{
	sprite_crouch_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_jump.png", 1, false, false, sprite_crouch_jump_xorig, sprite_crouch_jump_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall_strip" + string(index)+".png"))
	{
		sprite_crouch_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall_strip" + string(index)+".png", index, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall_strip" + string(index)+".png"))
	{
		sprite_crouch_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall_strip" + string(index)+".png", index, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall_strip" + string(index)+".png"))
	{
		sprite_crouch_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall_strip" + string(index)+".png", index, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall_strip" + string(index)+".png"))
	{
		sprite_crouch_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall_strip" + string(index)+".png", index, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall.png"))
{
	sprite_crouch_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall.png", 1, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall.png"))
{
	sprite_crouch_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall.png", 1, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall.png"))
{
	sprite_crouch_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/crouch_fall.png", 1, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall.png"))
{
	sprite_crouch_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/squat_fall.png", 1, false, false, sprite_crouch_fall_xorig, sprite_crouch_fall_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_strip" + string(index)+".png"))
	{
		sprite_skidding = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_strip" + string(index)+".png", index, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip_strip" + string(index)+".png"))
	{
		sprite_skidding = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip_strip" + string(index)+".png", index, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_strip" + string(index)+".png"))
	{
		sprite_skidding = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_strip" + string(index)+".png", index, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip_strip" + string(index)+".png"))
	{
		sprite_skidding = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip_strip" + string(index)+".png", index, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding.png"))
{
	sprite_skidding = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding.png", 1, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip.png"))
{
	sprite_skidding = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip.png", 1, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding.png"))
{
	sprite_skidding = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding.png", 1, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip.png"))
{
	sprite_skidding = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/slip.png", 1, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice_strip" + string(index)+".png"))
	{
		sprite_skidding_ice = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice_strip" + string(index)+".png", index, false, false, sprite_skidding_ice_xorig, sprite_skidding_ice_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice_strip" + string(index)+".png"))
	{
		sprite_skidding_ice = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice_strip" + string(index)+".png", index, false, false, sprite_skidding_ice_xorig, sprite_skidding_ice_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice.png"))
{
	sprite_skidding_ice = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice.png", 1, false, false, sprite_skidding_ice_xorig, sprite_skidding_ice_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice.png"))
{
	sprite_skidding_ice = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/skidding_ice.png", 1, false, false, sprite_skidding_xorig, sprite_skidding_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand_strip" + string(index)+".png"))
	{
		sprite_swim_stand = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand_strip" + string(index)+".png", index, false, false, sprite_swim_stand_xorig, sprite_swim_stand_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand_strip" + string(index)+".png"))
	{
		sprite_swim_stand = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand_strip" + string(index)+".png", index, false, false, sprite_swim_stand_xorig, sprite_swim_stand_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand.png"))
{
	sprite_swim_stand = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand.png", 1, false, false, sprite_swim_stand_xorig, sprite_swim_stand_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand.png"))
{
	sprite_swim_stand = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_stand.png", 1, false, false, sprite_swim_stand_xorig, sprite_swim_stand_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_strip" + string(index)+".png"))
	{
		sprite_swim = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_strip" + string(index)+".png", index, false, false, sprite_swim_xorig, sprite_swim_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_strip" + string(index)+".png"))
	{
		sprite_swim = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_strip" + string(index)+".png", index, false, false, sprite_swim_xorig, sprite_swim_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim.png"))
{
	sprite_swim = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim.png", 1, false, false, sprite_swim_xorig, sprite_swim_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim.png"))
{
	sprite_swim = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim.png", 1, false, false, sprite_swim_xorig, sprite_swim_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall_strip" + string(index)+".png"))
	{
		sprite_swim_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall_strip" + string(index)+".png", index, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall_strip" + string(index)+".png"))
	{
		sprite_swim_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall_strip" + string(index)+".png", index, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling_strip" + string(index)+".png"))
	{
		sprite_swim_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling_strip" + string(index)+".png", index, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling_strip" + string(index)+".png"))
	{
		sprite_swim_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling_strip" + string(index)+".png", index, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall.png"))
{
	sprite_swim_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall.png", 1, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall.png"))
{
	sprite_swim_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_fall.png", 1, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling.png"))
{
	sprite_swim_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling.png", 1, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling.png"))
{
	sprite_swim_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/swim_falling.png", 1, false, false, sprite_swim_fall_xorig, sprite_swim_fall_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall_strip" + string(index)+".png"))
	{
		sprite_against_wall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall_strip" + string(index)+".png", index, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall_strip" + string(index)+".png"))
	{
		sprite_against_wall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall_strip" + string(index)+".png", index, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall_strip" + string(index)+".png"))
	{
		sprite_against_wall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall_strip" + string(index)+".png", index, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall_strip" + string(index)+".png"))
	{
		sprite_against_wall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall_strip" + string(index)+".png", index, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall.png"))
{
	sprite_against_wall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall.png", 1, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall.png"))
{
	sprite_against_wall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall.png", 1, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall.png"))
{
	sprite_against_wall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/against_wall.png", 1, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall.png"))
{
	sprite_against_wall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/againstwall.png", 1, false, false, sprite_against_wall_xorig, sprite_against_wall_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk_strip" + string(index)+".png"))
	{
		sprite_walk = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk_strip" + string(index)+".png", index, false, false, sprite_walk_xorig, sprite_walk_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk_strip" + string(index)+".png"))
	{
		sprite_walk = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk_strip" + string(index)+".png", index, false, false, sprite_walk_xorig, sprite_walk_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk.png"))
{
	sprite_walk = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk.png", 1, false, false, sprite_walk_xorig, sprite_walk_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk.png"))
{
	sprite_walk = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/walk.png", 1, false, false, sprite_walk_xorig, sprite_walk_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run_strip" + string(index)+".png"))
	{
		sprite_run = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run_strip" + string(index)+".png", index, false, false, sprite_run_xorig, sprite_run_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash_strip" + string(index)+".png"))
	{
		sprite_run = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash_strip" + string(index)+".png", index, false, false, sprite_run_xorig, sprite_run_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run_strip" + string(index)+".png"))
	{
		sprite_run = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run_strip" + string(index)+".png", index, false, false, sprite_run_xorig, sprite_run_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash_strip" + string(index)+".png"))
	{
		sprite_run = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash_strip" + string(index)+".png", index, false, false, sprite_run_xorig, sprite_run_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run.png"))
{
	sprite_run = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run.png", 1, false, false, sprite_run_xorig, sprite_run_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash.png"))
{
	sprite_run = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash.png", 1, false, false, sprite_run_xorig, sprite_run_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run.png"))
{
	sprite_run = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run.png", 1, false, false, sprite_run_xorig, sprite_run_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash.png"))
{
	sprite_run = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash.png", 1, false, false, sprite_run_xorig, sprite_run_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2_strip" + string(index)+".png"))
	{
		sprite_run2 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2_strip" + string(index)+".png", index, false, false, sprite_run2_xorig, sprite_run2_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2_strip" + string(index)+".png"))
	{
		sprite_run2 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2_strip" + string(index)+".png", index, false, false, sprite_run2_xorig, sprite_run2_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2_strip" + string(index)+".png"))
	{
		sprite_run2 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2_strip" + string(index)+".png", index, false, false, sprite_run2_xorig, sprite_run2_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2_strip" + string(index)+".png"))
	{
		sprite_run2 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2_strip" + string(index)+".png", index, false, false, sprite_run2_xorig, sprite_run2_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2.png"))
{
	sprite_run2 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2.png", 1, false, false, sprite_run2_xorig, sprite_run2_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2.png"))
{
	sprite_run2 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2.png", 1, false, false, sprite_run2_xorig, sprite_run2_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2.png"))
{
	sprite_run2 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run2.png", 1, false, false, sprite_run2_xorig, sprite_run2_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2.png"))
{
	sprite_run2 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash2.png", 1, false, false, sprite_run2_xorig, sprite_run2_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3_strip" + string(index)+".png"))
	{
		sprite_run3 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3_strip" + string(index)+".png", index, false, false, sprite_run3_xorig, sprite_run3_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3_strip" + string(index)+".png"))
	{
		sprite_run3 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3_strip" + string(index)+".png", index, false, false, sprite_run3_xorig, sprite_run3_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3_strip" + string(index)+".png"))
	{
		sprite_run3 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3_strip" + string(index)+".png", index, false, false, sprite_run3_xorig, sprite_run3_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3_strip" + string(index)+".png"))
	{
		sprite_run3 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3_strip" + string(index)+".png", index, false, false, sprite_run3_xorig, sprite_run3_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3.png"))
{
	sprite_run3 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3.png", 1, false, false, sprite_run3_xorig, sprite_run3_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3.png"))
{
	sprite_run3 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3.png", 1, false, false, sprite_run3_xorig, sprite_run3_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3.png"))
{
	sprite_run3 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run3.png", 1, false, false, sprite_run3_xorig, sprite_run3_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3.png"))
{
	sprite_run3 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash3.png", 1, false, false, sprite_run3_xorig, sprite_run3_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4_strip" + string(index)+".png"))
	{
		sprite_run4 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4_strip" + string(index)+".png", index, false, false, sprite_run4_xorig, sprite_run4_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4_strip" + string(index)+".png"))
	{
		sprite_run4 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4_strip" + string(index)+".png", index, false, false, sprite_run4_xorig, sprite_run4_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4_strip" + string(index)+".png"))
	{
		sprite_run4 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4_strip" + string(index)+".png", index, false, false, sprite_run4_xorig, sprite_run4_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4_strip" + string(index)+".png"))
	{
		sprite_run4 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4_strip" + string(index)+".png", index, false, false, sprite_run4_xorig, sprite_run4_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4.png"))
{
	sprite_run4 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4.png", 1, false, false, sprite_run4_xorig, sprite_run4_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4.png"))
{
	sprite_run4 = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4.png", 1, false, false, sprite_run4_xorig, sprite_run4_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4.png"))
{
	sprite_run4 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/run4.png", 1, false, false, sprite_run4_xorig, sprite_run4_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4.png"))
{
	sprite_run4 = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dash4.png", 1, false, false, sprite_run4_xorig, sprite_run4_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump_strip" + string(index)+".png"))
	{
		sprite_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump_strip" + string(index)+".png", index, false, false, sprite_jump_xorig, sprite_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump_strip" + string(index)+".png"))
	{
		sprite_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump_strip" + string(index)+".png", index, false, false, sprite_jump_xorig, sprite_jump_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump.png"))
{
	sprite_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump.png", 1, false, false, sprite_jump_xorig, sprite_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump.png"))
{
	sprite_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/jump.png", 1, false, false, sprite_jump_xorig, sprite_jump_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump_strip" + string(index)+".png"))
	{
		sprite_double_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump_strip" + string(index)+".png", index, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump_strip" + string(index)+".png"))
	{
		sprite_double_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump_strip" + string(index)+".png", index, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump_strip" + string(index)+".png"))
	{
		sprite_double_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump_strip" + string(index)+".png", index, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump_strip" + string(index)+".png"))
	{
		sprite_double_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump_strip" + string(index)+".png", index, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump.png"))
{
	sprite_double_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump.png", 1, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump.png"))
{
	sprite_double_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump.png", 1, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump.png"))
{
	sprite_double_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/double_jump.png", 1, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump.png"))
{
	sprite_double_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/doublejump.png", 1, false, false, sprite_double_jump_xorig, sprite_double_jump_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump_strip" + string(index)+".png"))
	{
		sprite_triple_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump_strip" + string(index)+".png", index, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump_strip" + string(index)+".png"))
	{
		sprite_triple_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump_strip" + string(index)+".png", index, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump_strip" + string(index)+".png"))
	{
		sprite_triple_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump_strip" + string(index)+".png", index, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump_strip" + string(index)+".png"))
	{
		sprite_triple_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump_strip" + string(index)+".png", index, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump.png"))
{
	sprite_triple_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump.png", 1, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump.png"))
{
	sprite_triple_jump = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump.png", 1, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump.png"))
{
	sprite_triple_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triple_jump.png", 1, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump.png"))
{
	sprite_triple_jump = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/triplejump.png", 1, false, false, sprite_triple_jump_xorig, sprite_triple_jump_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_strip" + string(index)+".png"))
	{
		sprite_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_strip" + string(index)+".png", index, false, false, sprite_fall_xorig, sprite_fall_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_strip" + string(index)+".png"))
	{
		sprite_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_strip" + string(index)+".png", index, false, false, sprite_fall_xorig, sprite_fall_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall.png"))
{
	sprite_fall = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall.png", 1, false, false, sprite_fall_xorig, sprite_fall_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall.png"))
{
	sprite_fall = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall.png", 1, false, false, sprite_fall_xorig, sprite_fall_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower_strip" + string(index)+".png"))
	{
		sprite_fall_slower = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower_strip" + string(index)+".png", index, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower_strip" + string(index)+".png"))
	{
		sprite_fall_slower = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower_strip" + string(index)+".png", index, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower_strip" + string(index)+".png"))
	{
		sprite_fall_slower = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower_strip" + string(index)+".png", index, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower_strip" + string(index)+".png"))
	{
		sprite_fall_slower = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower_strip" + string(index)+".png", index, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower.png"))
{
	sprite_fall_slower = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower.png", 1, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower.png"))
{
	sprite_fall_slower = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower.png", 1, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower.png"))
{
	sprite_fall_slower = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fall_slower.png", 1, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower.png"))
{
	sprite_fall_slower = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/fallslower.png", 1, false, false, sprite_fall_slower_xorig, sprite_fall_slower_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still_strip" + string(index)+".png"))
	{
		sprite_climb_under_still = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still_strip" + string(index)+".png", index, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still_strip" + string(index)+".png"))
	{
		sprite_climb_under_still = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still_strip" + string(index)+".png", index, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still_strip" + string(index)+".png"))
	{
		sprite_climb_under_still = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still_strip" + string(index)+".png", index, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still_strip" + string(index)+".png"))
	{
		sprite_climb_under_still = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still_strip" + string(index)+".png", index, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still.png"))
{
	sprite_climb_under_still = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still.png", 1, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still.png"))
{
	sprite_climb_under_still = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still.png", 1, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still.png"))
{
	sprite_climb_under_still = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_still.png", 1, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still.png"))
{
	sprite_climb_under_still = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_still.png", 1, false, false, sprite_climb_under_still_xorig, sprite_climb_under_still_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_strip" + string(index)+".png"))
	{
		sprite_climb_under = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_strip" + string(index)+".png", index, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_strip" + string(index)+".png"))
	{
		sprite_climb_under = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_strip" + string(index)+".png", index, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_strip" + string(index)+".png"))
	{
		sprite_climb_under = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_strip" + string(index)+".png", index, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_strip" + string(index)+".png"))
	{
		sprite_climb_under = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_strip" + string(index)+".png", index, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under.png"))
{
	sprite_climb_under = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under.png", 1, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder.png"))
{
	sprite_climb_under = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder.png", 1, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under.png"))
{
	sprite_climb_under = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under.png", 1, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder.png"))
{
	sprite_climb_under = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder.png", 1, false, false, sprite_climb_under_xorig, sprite_climb_under_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up_strip" + string(index)+".png"))
	{
		sprite_climb_under_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up_strip" + string(index)+".png", index, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup_strip" + string(index)+".png"))
	{
		sprite_climb_under_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup_strip" + string(index)+".png", index, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up_strip" + string(index)+".png"))
	{
		sprite_climb_under_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up_strip" + string(index)+".png", index, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup_strip" + string(index)+".png"))
	{
		sprite_climb_under_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup_strip" + string(index)+".png", index, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up.png"))
{
	sprite_climb_under_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up.png", 1, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup.png"))
{
	sprite_climb_under_look_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup.png", 1, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up.png"))
{
	sprite_climb_under_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_look_up.png", 1, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup.png"))
{
	sprite_climb_under_look_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_lookup.png", 1, false, false, sprite_climb_under_look_up_xorig, sprite_climb_under_look_up_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin.png"))
{
	sprite_climb_under_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin.png", 1, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin.png"))
{
	sprite_climb_under_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin.png", 1, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin.png"))
{
	sprite_climb_under_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin.png", 1, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin.png"))
{
	sprite_climb_under_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin.png", 1, false, false, sprite_climb_under_spin_xorig, sprite_climb_under_spin_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin_fast = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin_fast = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin_fast = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast_strip" + string(index)+".png"))
	{
		sprite_climb_under_spin_fast = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast_strip" + string(index)+".png", index, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast.png"))
{
	sprite_climb_under_spin_fast = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast.png", 1, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast.png"))
{
	sprite_climb_under_spin_fast = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast.png", 1, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast.png"))
{
	sprite_climb_under_spin_fast = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climb_under_spin_fast.png", 1, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast.png"))
{
	sprite_climb_under_spin_fast = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/climbunder_spin_fast.png", 1, false, false, sprite_climb_under_spin_fast_xorig, sprite_climb_under_spin_fast_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_strip" + string(index)+".png"))
	{
		sprite_ground_pound = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_strip" + string(index)+".png", index, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_strip" + string(index)+".png"))
	{
		sprite_ground_pound = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_strip" + string(index)+".png", index, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_strip" + string(index)+".png"))
	{
		sprite_ground_pound = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_strip" + string(index)+".png", index, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_strip" + string(index)+".png"))
	{
		sprite_ground_pound = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_strip" + string(index)+".png", index, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound.png"))
{
	sprite_ground_pound = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound.png", 1, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound.png"))
{
	sprite_ground_pound = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound.png", 1, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound.png"))
{
	sprite_ground_pound = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound.png", 1, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound.png"))
{
	sprite_ground_pound = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound.png", 1, false, false, sprite_ground_pound_xorig, sprite_ground_pound_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up_strip" + string(index)+".png"))
	{
		sprite_ground_pound_get_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up_strip" + string(index)+".png", index, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup_strip" + string(index)+".png"))
	{
		sprite_ground_pound_get_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup_strip" + string(index)+".png", index, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up_strip" + string(index)+".png"))
	{
		sprite_ground_pound_get_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up_strip" + string(index)+".png", index, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup_strip" + string(index)+".png"))
	{
		sprite_ground_pound_get_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup_strip" + string(index)+".png", index, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up.png"))
{
	sprite_ground_pound_get_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up.png", 1, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup.png"))
{
	sprite_ground_pound_get_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup.png", 1, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up.png"))
{
	sprite_ground_pound_get_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/ground_pound_get_up.png", 1, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup.png"))
{
	sprite_ground_pound_get_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/groundpound_getup.png", 1, false, false, sprite_ground_pound_get_up_xorig, sprite_ground_pound_get_up_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin_strip" + string(index)+".png"))
	{
		sprite_stomp_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin_strip" + string(index)+".png", index, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin_strip" + string(index)+".png"))
	{
		sprite_stomp_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin_strip" + string(index)+".png", index, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin_strip" + string(index)+".png"))
	{
		sprite_stomp_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin_strip" + string(index)+".png", index, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin_strip" + string(index)+".png"))
	{
		sprite_stomp_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin_strip" + string(index)+".png", index, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin.png"))
{
	sprite_stomp_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin.png", 1, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin.png"))
{
	sprite_stomp_spin = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin.png", 1, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin.png"))
{
	sprite_stomp_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stomp_spin.png", 1, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin.png"))
{
	sprite_stomp_spin = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/stompspin.png", 1, false, false, sprite_stomp_spin_xorig, sprite_stomp_spin_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up_strip" + string(index)+".png"))
	{
		sprite_spring_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up_strip" + string(index)+".png", index, false, false, sprite_spring_up_xorig, sprite_spring_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up_strip" + string(index)+".png"))
	{
		sprite_spring_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up_strip" + string(index)+".png", index, false, false, sprite_spring_up_xorig, sprite_spring_up_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up.png"))
{
	sprite_spring_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up.png", 1, false, false, sprite_spring_up_xorig, sprite_spring_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up.png"))
{
	sprite_spring_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_up.png", 1, false, false, sprite_spring_up_xorig, sprite_spring_up_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition_strip" + string(index)+".png"))
	{
		sprite_spring_transition = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition_strip" + string(index)+".png", index, false, false, sprite_spring_transition_xorig, sprite_spring_transition_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition_strip" + string(index)+".png"))
	{
		sprite_spring_transition = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition_strip" + string(index)+".png", index, false, false, sprite_spring_transition_xorig, sprite_spring_transition_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition.png"))
{
	sprite_spring_transition = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition.png", 1, false, false, sprite_spring_transition_xorig, sprite_spring_transition_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition.png"))
{
	sprite_spring_transition = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_transition.png", 1, false, false, sprite_spring_transition_xorig, sprite_spring_transition_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down_strip" + string(index)+".png"))
	{
		sprite_spring_down = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down_strip" + string(index)+".png", index, false, false, sprite_spring_down_xorig, sprite_spring_down_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down_strip" + string(index)+".png"))
	{
		sprite_spring_down = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down_strip" + string(index)+".png", index, false, false, sprite_spring_down_xorig, sprite_spring_down_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down.png"))
{
	sprite_spring_down = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down.png", 1, false, false, sprite_spring_down_xorig, sprite_spring_down_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down.png"))
{
	sprite_spring_down = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/spring_down.png", 1, false, false, sprite_spring_down_xorig, sprite_spring_down_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_strip" + string(index)+".png"))
	{
		sprite_wall_slide = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_strip" + string(index)+".png", index, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_strip" + string(index)+".png"))
	{
		sprite_wall_slide = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_strip" + string(index)+".png", index, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_strip" + string(index)+".png"))
	{
		sprite_wall_slide = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_strip" + string(index)+".png", index, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_strip" + string(index)+".png"))
	{
		sprite_wall_slide = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_strip" + string(index)+".png", index, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide.png"))
{
	sprite_wall_slide = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide.png", 1, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide.png"))
{
	sprite_wall_slide = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide.png", 1, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide.png"))
{
	sprite_wall_slide = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide.png", 1, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide.png"))
{
	sprite_wall_slide = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide.png", 1, false, false, sprite_wall_slide_xorig, sprite_wall_slide_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up_strip" + string(index)+".png"))
	{
		sprite_wall_slide_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up_strip" + string(index)+".png", index, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up_strip" + string(index)+".png"))
	{
		sprite_wall_slide_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up_strip" + string(index)+".png", index, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up_strip" + string(index)+".png"))
	{
		sprite_wall_slide_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up_strip" + string(index)+".png", index, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up_strip" + string(index)+".png"))
	{
		sprite_wall_slide_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up_strip" + string(index)+".png", index, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up.png"))
{
	sprite_wall_slide_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up.png", 1, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up.png"))
{
	sprite_wall_slide_up = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up.png", 1, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up.png"))
{
	sprite_wall_slide_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_up.png", 1, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up.png"))
{
	sprite_wall_slide_up = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_up.png", 1, false, false, sprite_wall_slide_up_xorig, sprite_wall_slide_up_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down_strip" + string(index)+".png"))
	{
		sprite_wall_slide_down = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down_strip" + string(index)+".png", index, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
	}
	else
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down_strip" + string(index)+".png"))
	{
		sprite_wall_slide_down = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down_strip" + string(index)+".png", index, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down_strip" + string(index)+".png"))
	{
		sprite_wall_slide_down = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down_strip" + string(index)+".png", index, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down_strip" + string(index)+".png"))
	{
		sprite_wall_slide_down = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down_strip" + string(index)+".png", index, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down.png"))
{
	sprite_wall_slide_down = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down.png", 1, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
}
else
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down.png"))
{
	sprite_wall_slide_down = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down.png", 1, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down.png"))
{
	sprite_wall_slide_down = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wall_slide_down.png", 1, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down.png"))
{
	sprite_wall_slide_down = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/wallslide_down.png", 1, false, false, sprite_wall_slide_down_xorig, sprite_wall_slide_down_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive_strip" + string(index)+".png"))
	{
		sprite_dive = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive_strip" + string(index)+".png", index, false, false, sprite_dive_xorig, sprite_dive_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive_strip" + string(index)+".png"))
	{
		sprite_dive = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive_strip" + string(index)+".png", index, false, false, sprite_dive_xorig, sprite_dive_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive.png"))
{
	sprite_dive = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive.png", 1, false, false, sprite_dive_xorig, sprite_dive_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive.png"))
{
	sprite_dive = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/dive.png", 1, false, false, sprite_dive_xorig, sprite_dive_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die_strip" + string(index)+".png"))
	{
		sprite_die = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die_strip" + string(index)+".png", index, false, false, sprite_die_xorig, sprite_die_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die_strip" + string(index)+".png"))
	{
		sprite_die = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die_strip" + string(index)+".png", index, false, false, sprite_die_xorig, sprite_die_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die.png"))
{
	sprite_die = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die.png", 1, false, false, sprite_die_xorig, sprite_die_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die.png"))
{
	sprite_die = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/die.png", 1, false, false, sprite_die_xorig, sprite_die_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait_strip" + string(index)+".png"))
	{
		sprite_game_over_character_portrait = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait_strip" + string(index)+".png", index, false, false, sprite_game_over_character_portrait_xorig, sprite_game_over_character_portrait_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait_strip" + string(index)+".png"))
	{
		sprite_game_over_character_portrait = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait_strip" + string(index)+".png", index, false, false, sprite_game_over_character_portrait_xorig, sprite_game_over_character_portrait_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait.png"))
{
	sprite_game_over_character_portrait = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait.png", 1, false, false, sprite_game_over_character_portrait_xorig, sprite_game_over_character_portrait_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait.png"))
{
	sprite_game_over_character_portrait = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/game_over_character_portrait.png", 1, false, false, sprite_game_over_character_portrait_xorig, sprite_game_over_character_portrait_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb_strip" + string(index)+".png"))
	{
		sprite_vine_climb = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb_strip" + string(index)+".png", index, false, false, sprite_vine_climb_xorig, sprite_vine_climb_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb_strip" + string(index)+".png"))
	{
		sprite_vine_climb = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb_strip" + string(index)+".png", index, false, false, sprite_vine_climb_xorig, sprite_vine_climb_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb.png"))
{
	sprite_vine_climb = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb.png", 1, false, false, sprite_vine_climb_xorig, sprite_vine_climb_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb.png"))
{
	sprite_vine_climb = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_climb.png", 1, false, false, sprite_vine_climb_xorig, sprite_vine_climb_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay_strip" + string(index)+".png"))
	{
		sprite_vine_stay = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay_strip" + string(index)+".png", index, false, false, sprite_vine_stay_xorig, sprite_vine_stay_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay_strip" + string(index)+".png"))
	{
		sprite_vine_stay = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay_strip" + string(index)+".png", index, false, false, sprite_vine_stay_xorig, sprite_vine_stay_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay.png"))
{
	sprite_vine_stay = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay.png", 1, false, false, sprite_vine_stay_xorig, sprite_vine_stay_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay.png"))
{
	sprite_vine_stay = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/vine_stay.png", 1, false, false, sprite_vine_stay_xorig, sprite_vine_stay_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat_strip" + string(index)+".png"))
	{
		sprite_sitting_down_to_eat = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat_strip" + string(index)+".png", index, false, false, sprite_sitting_down_to_eat_xorig, sprite_sitting_down_to_eat_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat_strip" + string(index)+".png"))
	{
		sprite_sitting_down_to_eat = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat_strip" + string(index)+".png", index, false, false, sprite_sitting_down_to_eat_xorig, sprite_sitting_down_to_eat_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat.png"))
{
	sprite_sitting_down_to_eat = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat.png", 1, false, false, sprite_sitting_down_to_eat_xorig, sprite_sitting_down_to_eat_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat.png"))
{
	sprite_sitting_down_to_eat = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_down_to_eat.png", 1, false, false, sprite_sitting_down_to_eat_xorig, sprite_sitting_down_to_eat_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_closed_mouth = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_closed_mouth_xorig, sprite_sitting_eat_closed_mouth_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_closed_mouth = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_closed_mouth_xorig, sprite_sitting_eat_closed_mouth_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth.png"))
{
	sprite_sitting_eat_closed_mouth = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth.png", 1, false, false, sprite_sitting_eat_closed_mouth_xorig, sprite_sitting_eat_closed_mouth_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth.png"))
{
	sprite_sitting_eat_closed_mouth = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_closed_mouth.png", 1, false, false, sprite_sitting_eat_closed_mouth_xorig, sprite_sitting_eat_closed_mouth_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_open_mouth = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_open_mouth_xorig, sprite_sitting_eat_open_mouth_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_open_mouth = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_open_mouth_xorig, sprite_sitting_eat_open_mouth_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth.png"))
{
	sprite_sitting_eat_open_mouth = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth.png", 1, false, false, sprite_sitting_eat_open_mouth_xorig, sprite_sitting_eat_open_mouth_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth.png"))
{
	sprite_sitting_eat_open_mouth = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth.png", 1, false, false, sprite_sitting_eat_open_mouth_xorig, sprite_sitting_eat_open_mouth_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_open_mouth_open_eye = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_open_mouth_open_eye_xorig, sprite_sitting_eat_open_mouth_open_eye_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_open_mouth_open_eye = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_open_mouth_open_eye_xorig, sprite_sitting_eat_open_mouth_open_eye_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye.png"))
{
	sprite_sitting_eat_open_mouth_open_eye = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye.png", 1, false, false, sprite_sitting_eat_open_mouth_open_eye_xorig, sprite_sitting_eat_open_mouth_open_eye_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye.png"))
{
	sprite_sitting_eat_open_mouth_open_eye = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_open_mouth_open_eye.png", 1, false, false, sprite_sitting_eat_open_mouth_open_eye_xorig, sprite_sitting_eat_open_mouth_open_eye_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_surprised = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_surprised_xorig, sprite_sitting_eat_surprised_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised_strip" + string(index)+".png"))
	{
		sprite_sitting_eat_surprised = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised_strip" + string(index)+".png", index, false, false, sprite_sitting_eat_surprised_xorig, sprite_sitting_eat_surprised_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised.png"))
{
	sprite_sitting_eat_surprised = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised.png", 1, false, false, sprite_sitting_eat_surprised_xorig, sprite_sitting_eat_surprised_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised.png"))
{
	sprite_sitting_eat_surprised = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eat_surprised.png", 1, false, false, sprite_sitting_eat_surprised_xorig, sprite_sitting_eat_surprised_yorig);
}
...
repeat(50)
{
	if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating_strip" + string(index)+".png"))
	{
		sprite_sitting_eating = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating_strip" + string(index)+".png", index, false, false, sprite_sitting_eating_xorig, sprite_sitting_eating_yorig);
	}
	else
	if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating_strip" + string(index)+".png"))
	{
		sprite_sitting_eating = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating_strip" + string(index)+".png", index, false, false, sprite_sitting_eating_xorig, sprite_sitting_eating_yorig);
	}
	index += 1;
}
if (file_exists("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating.png"))
{
	sprite_sitting_eating = sprite_add("characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating.png", 1, false, false, sprite_sitting_eating_xorig, sprite_sitting_eating_yorig);
}
else
if (file_exists(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating.png"))
{
	sprite_sitting_eating = sprite_add(working_directory + "/custom_characters/" + string(ds_list_find_value(global.all_loaded_characters, global.character_index[player-1]))+"/sprites/sitting_eating.png", 1, false, false, sprite_sitting_eating_xorig, sprite_sitting_eating_yorig);
}
