...
sprite_standing_on_something = scr_initialize_custom_character_sprite("standing_on_something_strip", sprite_standing_on_something, sprite_standing_on_something_xorig, sprite_standing_on_something_yorig);
