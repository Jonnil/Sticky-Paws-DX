...
and(global.character_select_in_this_menu="level_editor")
{
	...
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.bmp",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*BMP Custom Thumbnail*/
	
	//#region /*PNG Custom Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.png"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.png",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*PNG Custom Thumbnail*/
	
	//#region /*GIF Custom Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.gif"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.gif",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*GIF Custom Thumbnail*/
	
	//#region /*JPG Custom Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.jpg"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Thumbnail.jpg",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*JPG Custom Thumbnail*/
	
	//#region /*BMP Automatic Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.bmp"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.bmp",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*BMP Automatic Thumbnail*/
	
	//#region /*PNG Automatic Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.png"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.png",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*PNG Automatic Thumbnail*/
	
	//#region /*GIF Automatic Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.gif"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.gif",0,false,true,view_xview+view_wview/2,0);
	}
	else
	#endregion /*GIF Automatic Thumbnail*/
	
	//#region /*JPG Automatic Thumbnail*/
	/*if (file_exists(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.jpg"))
	{
		global.thumbnail_sprite=sprite_add(working_directory+"/Custom Levels/"+string(ds_list_find_value(global.all_loaded_custom_levels,global.select_level_index))+"/Automatic Thumbnail.jpg",0,false,true,view_xview+view_wview/2,0);
	}
