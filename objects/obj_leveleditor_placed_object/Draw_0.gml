...
if (global.world_editor = false)
{
	...
	if (object = 48){draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "1", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 49){draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "2", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 50){draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "3", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 51){draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "4", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 52){draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "5", global.default_text_size, image_blend, c_black, image_alpha);}
	...
	if (object = 56) and (sprite_lives_icon > noone){draw_sprite_ext(sprite_lives_icon, 0, x, y, 1, 1, 0, image_blend, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);
	draw_text_outlined(x, y, "1-up", global.default_text_size / 2, image_blend, c_black, image_alpha);}
	if (object = 57) and (sprite_lives_icon > noone){draw_sprite_ext(sprite_lives_icon, 0, x, y, 1, 1, 0, c_lime, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);
	draw_text_outlined(x, y, "2-up", global.default_text_size / 2, image_blend, c_black, image_alpha);}
	if (object = 58) and (sprite_lives_icon > noone){draw_sprite_ext(sprite_lives_icon, 0, x, y, 1, 1, 0, c_blue, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);
	...
	if (object = 80) and (asset_get_type("spr_bucket") == asset_sprite){if (asset_get_type("spr_1up") == asset_sprite){draw_sprite_ext(spr_1up, 0, x, y, 0.5, 0.5, 0, image_blend, image_alpha);}draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "1-up", global.default_text_size / 2, image_blend, c_black, image_alpha);}
	if (object = 81) and (asset_get_type("spr_bucket") == asset_sprite){if (asset_get_type("spr_2up") == asset_sprite){draw_sprite_ext(spr_2up, 0, x, y, 0.5, 0.5, 0, image_blend, image_alpha);}draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "2-up", global.default_text_size / 2, image_blend, c_black, image_alpha);}
	if (object = 82) and (asset_get_type("spr_bucket") == asset_sprite){if (asset_get_type("spr_3up") == asset_sprite){draw_sprite_ext(spr_3up, 0, x, y, 0.5, 0.5, 0, image_blend, image_alpha);}draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "3-up", global.default_text_size / 2, image_blend, c_black, image_alpha);}
	if (object = 83) and (asset_get_type("spr_bucket") == asset_sprite){draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "1", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 84) and (asset_get_type("spr_bucket") == asset_sprite){draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "2", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 85) and (asset_get_type("spr_bucket") == asset_sprite){draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "3", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 86) and (asset_get_type("spr_bucket") == asset_sprite){draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "4", global.default_text_size, image_blend, c_black, image_alpha);}
	if (object = 87) and (asset_get_type("spr_bucket") == asset_sprite){draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);draw_set_halign(fa_center);draw_set_valign(fa_middle);draw_text_outlined(x, y, "5", global.default_text_size, image_blend, c_black, image_alpha);}
