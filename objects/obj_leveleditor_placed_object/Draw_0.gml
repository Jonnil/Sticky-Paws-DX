if (global.actually_play_edited_level == false)
{
	...
	if (global.world_editor == false)
	{
		...
		/* Bump Big Collectible */ if (object == level_object_id.id_bump_in_ground_big_collectible) and (asset_get_type("spr_bump_in_ground") == asset_sprite){draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);}
		...
		/* Invisible Bump Big Collectible */ if (object == level_object_id.id_invisible_bump_in_ground_big_collectible) and (asset_get_type("spr_bump_in_ground") == asset_sprite){draw_sprite_ext(spr_bump_in_ground, 0, x, y, 1, 1, 0, image_blend, image_alpha * 0.5);draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha * 0.5);}
		...
		if (object == level_object_id.id_bucket_big_collectible) and (asset_get_type("spr_bucket") == asset_sprite){draw_sprite_ext(spr_bucket, 0, x, y, 1, 1, 0, image_blend, image_alpha);draw_sprite_ext(global.resource_pack_sprite_big_collectible, 0, x, y, 0.4, 0.4, 0, image_blend, image_alpha);}
