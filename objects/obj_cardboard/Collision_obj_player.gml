...
and (other.vspeed < 0)
or (place_meeting(x, y - 16, other))
and (other.ground_pound == true)
or (place_meeting(bbox_left - 8, y, other))
and (other.dive == true)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
or (place_meeting(bbox_right + 8, y, other))
and (other.dive == true)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
or (place_meeting(bbox_left - 1, y, other))
and (other.wall_jump > 0)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
or (place_meeting(bbox_right + 1, y, other))
and (other.wall_jump > 0)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))

or (place_meeting(bbox_left - 8, y, other))
and (other.move_towards_spring_endpoint == true)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
or (place_meeting(bbox_right + 8, y, other))
and (other.move_towards_spring_endpoint == true)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
or (place_meeting(x, bbox_top - 8, other))
and (other.move_towards_spring_endpoint == true)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
or (place_meeting(x, bbox_bottom + 8, other))
and (other.move_towards_spring_endpoint == true)
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
...
and (!collision_line(x, y, other.x, other.y, obj_wall, false, true))
{
	...
	scr_gamepad_vibration(other.player, 0.4, 10);
	instance_destroy();
}
