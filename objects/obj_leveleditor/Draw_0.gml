...
if (selected_object = 32){place_object = "invincibility_powerup_coil_spring";can_make_place_brush_size_bigger = true;draw_sprite_ext(global.resourcepack_sprite_coil_spring, 0, x, y + 16, 1, 1, 0, c_white, 0.5);draw_sprite_ext(global.resourcepack_sprite_invincibility_powerup, 0, x, y, 1, 1, 0, c_white, 0.5);sprite_index = noone;mask_index = spr_wall;}
...
if (selected_object = 41){place_object = "blaster";can_make_place_brush_size_bigger = true;sprite_index = global.resourcepack_sprite_blaster;mask_index = spr_wall;}
...
if (quit_level_editor <= 0)
{
	...
	draw_sprite_ext(global.resourcepack_sprite_coil_spring, 0,																camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 32, camera_get_view_y(view_camera[view_current]) + 64 + 16, 1, 1, 0, c_white,selected_menu_alpha);draw_sprite_ext(global.resourcepack_sprite_invincibility_powerup, 0, camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 32, camera_get_view_y(view_camera[view_current]) + 64, 1, 1, 0, c_white,selected_menu_alpha);
	if (sprite_lives_icon > noone){draw_sprite_ext(sprite_lives_icon, 0,													camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 33, camera_get_view_y(view_camera[view_current]) + 64, 1, 1, 0, c_white,selected_menu_alpha);draw_set_halign(fa_center);draw_set_valign(fa_center);draw_text_outlined(camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 33, camera_get_view_y(view_camera[view_current]) + 64, "1-up", global.default_text_size / 2, c_white, c_black,selected_menu_alpha);}
	if (sprite_lives_icon > noone){draw_sprite_ext(sprite_lives_icon, 0,													camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 34, camera_get_view_y(view_camera[view_current]) + 64, 1, 1, 0, c_lime,selected_menu_alpha);draw_set_halign(fa_center);draw_set_valign(fa_center);draw_text_outlined(camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 34, camera_get_view_y(view_camera[view_current]) + 64, "2-up", global.default_text_size / 2, c_white, c_black,selected_menu_alpha);}
	if (sprite_lives_icon > noone){draw_sprite_ext(sprite_lives_icon, 0,													camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 35, camera_get_view_y(view_camera[view_current]) + 64, 1, 1, 0, c_blue,selected_menu_alpha);draw_set_halign(fa_center);draw_set_valign(fa_center);draw_text_outlined(camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 35, camera_get_view_y(view_camera[view_current]) + 64, "3-up", global.default_text_size / 2, c_white, c_black,selected_menu_alpha);}
	...
	draw_sprite_ext(global.resourcepack_sprite_blaster, 0,																	camera_get_view_x(view_camera[view_current]) + camera_get_view_width(view_camera[view_current])/ 2 + selected_object_menu_x + 64 * 41, camera_get_view_y(view_camera[view_current]) + 64, 1, 1, 0, c_white,selected_menu_alpha);
