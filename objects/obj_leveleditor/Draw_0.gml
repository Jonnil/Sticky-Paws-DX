...
total_number_of_objects=40;/*This is the total number of objects you have in the list to let the level editor know (0 is counted as object number 1) */
...
if (selected_object=32){place_object="air_bubbles_spawner";can_make_place_brush_size_bigger=false;if (asset_get_type("spr_air_bubbles_spawner")==asset_sprite){sprite_index=spr_air_bubbles_spawner;}else if (asset_get_type("spr_bubble")==asset_sprite){sprite_index=spr_bubble;}mask_index=spr_wall;}
