...
if (selected_object=32){place_object="air_bubbles_spawner";can_make_place_brush_size_bigger=true;if (asset_get_type("spr_air_bubbles_spawner")==asset_sprite){sprite_index=spr_air_bubbles_spawner;}else
if (asset_get_type("spr_bubble")==asset_sprite){sprite_index=spr_bubble;}mask_index=spr_wall;}
...
if (quit_level_editor=0)
{
	...
	if (asset_get_type("spr_bubble")==asset_sprite){draw_sprite_ext(spr_bubble,0,									camera_get_view_x(view_camera[view_current])+camera_get_view_width(view_camera[view_current])/2+selected_object_menu_x+64*32,camera_get_view_y(view_camera[view_current])+64,1,1,0,c_white,selected_menu_alpha);}
